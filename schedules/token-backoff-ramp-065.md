once: 2026-09-27T18:00:00Z
job_basename_prefix: token-backoff-ramp-065
---
Run this exact command from the garden root checkout and report only its
output:

    scripts/jobs/set-token-backoff-fraction.sh 0.65
...
"set token-backoff-fraction=0.65" or "no change (already 0.65)", either
