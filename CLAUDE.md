...
- Roles: `liaison`, `steward`, `understudy`, `general-contractor`, `monitor`, `review-queue`, `boatman`, `builder`, `assayer`, `cleaner`, `judge`, `assessor`, `typist`, `stylist`, `packager`, `archivist`, `prover`, `curator`, `migrator`, `locksmith`, `warden`, `saboteur`, `breaker`, `critic`, `skeptic`, `decomplector`, `ergonomist`, `copyeditor`, `pedant`, `novice`, `fixer`, `weaver`, `shepherd`, `conductor`, `designer`, `scout`, `botanist`, `major-general`, `gardener`, `evaluator`, `groom`, `investigator`, `journalist`, `librarian`, `scholar`, `timekeeper`. The nineteen jury-seat roles split across two default panels the `judge` dispatches per `skills/pr-creation-flow/SKILL.md` § Jury composition: the **code panel** of twelve seats (`assessor`, `typist`, `stylist`, `packager`, `archivist`, `prover`, `curator`, `migrator`, `locksmith`, `warden`, `saboteur`, `breaker`) reviews source-touching PRs, and the **design panel** of seven seats (`critic`, `skeptic`, `decomplector`, `ergonomist`, `copyeditor`, `pedant`, `novice`) reviews design-only PRs (paths under `<project>/designs/`). The judge picks the panel from the PR's file list per `roles/judge/AGENT.md` § Panel-kind discrimination; the orchestrator never dispatches a juror seat directly. The single generic `juror` role was retired in the 2026-05-14 redesign in favor of the named seats; the same day, each of the six initial named seats was halved into two successor seats for the twelve-seat code panel; later the same day, the five-seat design panel landed alongside the code panel. On 2026-05-15 the design panel grew from five seats to seven with the addition of `decomplector` (Rich-Hickey-lens reader: simple-vs-easy, complecting, value-vs-place, minimum viable abstraction) and `ergonomist` (interface-ergonomics reader on the proposed API or UI surface).
