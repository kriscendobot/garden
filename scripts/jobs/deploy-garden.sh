...
: "${GARDEN_DEPLOY_TEST_SUITES:=scripts/jobs/test/empty-output-classifier-test.sh scripts/jobs/test/signal-kill-classifier-test.sh scripts/jobs/test/terminal-handler-failure-reap-test.sh scripts/jobs/test/retry-narrowing-test.sh scripts/jobs/test/triager-pacing-test.sh scripts/jobs/test/ranked-promotion-test.sh scripts/jobs/test/policy-refusal-quarantine-test.sh scripts/jobs/test/codex-policy-refusal-resume-test.sh scripts/jobs/test/provider-cooldown-test.sh scripts/jobs/test/api-cooldown-test.sh scripts/jobs/test/claude-stream-signal-test.sh scripts/jobs/test/install-units-paused-disable-test.sh}"
