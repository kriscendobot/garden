...
run_seed() {
    env -u ANTHROPIC_API_KEY -u MOONSHOT_API_KEY -u FIREWORKS_API_KEY -u OPENROUTER_API_KEY -u OLLAMA_CLOUD_API_KEY -u TYPESAFE_API_KEY \
...
run_seed env ANTHROPIC_API_KEY=synthetic-anthropic MOONSHOT_API_KEY=synthetic-moonshot FIREWORKS_API_KEY=synthetic-fireworks OPENROUTER_API_KEY=synthetic-openrouter OLLAMA_CLOUD_API_KEY=synthetic-ollama-cloud TYPESAFE_API_KEY=synthetic-typesafe
