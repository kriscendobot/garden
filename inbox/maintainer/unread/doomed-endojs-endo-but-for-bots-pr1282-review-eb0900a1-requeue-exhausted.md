...
sent_at: 2026-09-18T22:23:52Z
doom_base: endojs-endo-but-for-bots-pr1282-review-eb0900a1
doom_signature: requeue-exhausted
notice_count: 1
first_seen: 2026-09-18T22:23:52Z
last_seen: 2026-09-18T22:23:52Z
---
SPLIT-ELIGIBLE job PARKED in jobs/plan/ (held, gate=go-ahead) after its sole backed-off retry also exited non-productively on endolin-garden-ece02cb4.
The reaper stopped retrying it; split it into claim-sized stages or surface it as indivisible.
The work is preserved at jobs/plan/endojs-endo-but-for-bots-pr1282-review-eb0900a1; it stays HELD until a human promotes it
(promote-plan.sh endojs-endo-but-for-bots-pr1282-review-eb0900a1) or removes it, so nothing is lost.
Original job base: endojs-endo-but-for-bots-pr1282-review-eb0900a1
...
# Review directive on endojs/endo-but-for-bots PR #1282

A trusted maintainer/contributor REVIEW on #1282. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/1282#pullrequestreview-5252957728
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/1282/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/1282/reviews/REVIEW_ID --jq .body
...
[CHANGES_REQUESTED] @kriscendobot Are you familiar with the Streisand Effect. Please do not merely amend doctrine. Please delete former doctrine so it does not persist as a distraction that might confuse a future maintainer or their agent. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1282 5252957728 kriskowal
