...
sent_at: 2026-09-22T00:14:29Z
doom_base: endojs-endo-but-for-bots-pr1286-review-cc7d78b9
doom_signature: requeue-exhausted
notice_count: 1
first_seen: 2026-09-22T00:14:29Z
last_seen: 2026-09-22T00:14:29Z
---
SPLIT-ELIGIBLE job PARKED in jobs/plan/ (held, gate=go-ahead) after its sole backed-off retry also exited non-productively on endolin-garden-ece02cb4.
The reaper stopped retrying it; split it into claim-sized stages or surface it as indivisible.
The work is preserved at jobs/plan/endojs-endo-but-for-bots-pr1286-review-cc7d78b9; it stays HELD until a human promotes it
(promote-plan.sh endojs-endo-but-for-bots-pr1286-review-cc7d78b9) or removes it, so nothing is lost.
Original job base: endojs-endo-but-for-bots-pr1286-review-cc7d78b9
...
# Review directive on endojs/endo-but-for-bots PR #1286

A trusted maintainer/contributor REVIEW on #1286. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/1286#pullrequestreview-5271817207
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/1286/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/1286/reviews/REVIEW_ID --jq .body
...
@kriscendobot Please shepherd first. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1286 5271817207 kriskowal
