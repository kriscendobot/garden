...
- **External-author calibration.** Same as the barrister: house-prose-style findings downgrade to `drop` on external-author PRs; proposed-rule findings escalate to the improver/watchman.
