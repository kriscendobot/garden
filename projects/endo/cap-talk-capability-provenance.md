...
## The 2011 boundary arc: values, transport, persistence, and proof scope

The January-March 2011 threads sharpen four boundaries that Endo encodes directly. Service chaining demonstrates why authority should travel as a narrow reference rather than an identity. Deeply immutable copy-data is distinct from an identity-bearing remotable, and CapTP is the bounded cryptographic bridge between local object-capability islands. Waterken's end-of-turn checkpoint model shows that atomic durable state depends on classifying every host-language failure correctly. The seL4 discussion supplies the proof-scope rule: a verified enforcement substrate lets components above it be reasoned about separately, but the claim does not extend beyond the audited boundary. Zooko's triangle adds the UI counterpart: machine designation and human naming are different layers joined by a holder-specific trusted path.

- [`../../library/sections/cap-talk-2009-2012--capability-adoption-through-service-chaining.md`](../../library/sections/cap-talk-2009-2012--capability-adoption-through-service-chaining.md)
- [`../../library/sections/cap-talk-2009-2012--zookos-triangle-and-petname-mappings.md`](../../library/sections/cap-talk-2009-2012--zookos-triangle-and-petname-mappings.md)
- [`../../library/sections/cap-talk-2009-2012--immutable-data-and-the-authority-boundary.md`](../../library/sections/cap-talk-2009-2012--immutable-data-and-the-authority-boundary.md)
- [`../../library/sections/cap-talk-2009-2012--covert-channels-and-bounded-crypto-code.md`](../../library/sections/cap-talk-2009-2012--covert-channels-and-bounded-crypto-code.md)
- [`../../library/sections/cap-talk-2009-2012--waterken-persistence-transactions-and-failure.md`](../../library/sections/cap-talk-2009-2012--waterken-persistence-transactions-and-failure.md)
- [`../../library/sections/cap-talk-2009-2012--sel4-verification-and-the-tcb-boundary.md`](../../library/sections/cap-talk-2009-2012--sel4-verification-and-the-tcb-boundary.md)
...
Scholar jobs `scholar-ingest-cap-talk`, `scholar-ingest-cap-talk-1999`, `scholar-ingest-cap-talk-2000-2003`, `scholar-ingest-cap-talk-2004-2008`, and `scholar-ingest-cap-talk-2004-2008-remainder` (2026-09-16), through the complete 2004-2008 monthly index; `scholar-ingest-cap-talk-2009-2012` (2026-09-16), the JavaScript / Caja / SES / web-key era first pass (2009 Q1); `scholar-ingest-cap-talk-2009-2012-remainder` (2026-09-16), the rest of 2009's fetchable standout threads; `scholar-ingest-cap-talk-2010-2012-remainder` and `scholar-ingest-cap-talk-2011-2012` (2026-09-16), all of 2010 anchored and sectioned; `scholar-ingest-cap-talk-2012-remainder` (2026-09-16), January-March 2011 anchored and sectioned with open question 56; `scholar-ingest-cap-talk-2013-2016` (2026-09-16), the final Pipermail slice through January 2016. April-December 2011 and all of 2012 remain deferred to `scholar-ingest-cap-talk-2011-2012-remainder`.
