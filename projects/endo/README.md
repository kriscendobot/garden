...
- [cap-talk-capability-provenance.md](cap-talk-capability-provenance.md): what the cap-talk archive says that bears on Endo's design, from caretaker revocation, connectivity discipline, and storage accounting through CapDesk/Polaris, web-keys and petnames, eventual references, powerboxes, and durable-session failure. Cross-links the era indexes from `cap-talk-1998` through `cap-talk-2004-2008` and the Miller/Close paper sections. Scholar jobs `scholar-ingest-cap-talk*` (2026-09-16).
