#!/bin/bash
# panel-hints.sh — recommend which jury seats to dispatch based on diff signals.
#
# Usage:
...
# The judge (solicitor / barrister / justice) consults the output at top-of-dispatch
# and dispatches the recommended set concurrently.
#
