...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| `no-ascii-banners`            | No box-drawing chars (U+2500–U+257F) or `+--+` / `|...|` boxes in changed `.md` or `.js` files.                   | PR #238 inline `r3237804603`; PR #75 `r3267751127`. Mermaid-over-ASCII rule. |
