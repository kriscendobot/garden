...
#
# Prints the human-readable per-run report. The skill driver prints this on
# every run (including no-motion runs). The dispatched builder copies the
# rendered output into the upgrade-PR body when a plan is non-empty.
