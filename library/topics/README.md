...
| [chat-ui](chat-ui.md) | Familiar Chat — the web-based keyboard-first UI for the Endo daemon; UI invariants, principles, and component designs. | 53 |
...
| [testing](testing.md) | How to run and write tests in endo. | 16 |
