...
| [networking](networking.md) | Transport-layer design (kriskowal/cask): UDP block transfer reacting against TCP's limits, the layered casknet protocol stack, Noise-IK/PSK encryption (with the cryptography.md design proposal behind it), 256-bit priority load shedding, casktel telemetry. | 21 |
