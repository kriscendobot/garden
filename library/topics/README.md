...
| [repository-governance](repository-governance.md) | Contribution rules, security policy, commit conventions, repository structure. | 41 |
...
| [capability-security](capability-security.md) | Object-capability discipline as practiced in Endo / Agoric. | 75 |
...
| [captp](captp.md) | Capability Transport Protocol: cross-process eventual-send. | 38 |
| [ocapn](ocapn.md) | The OCapN protocol family: CapTP + marshal + transports. | 65 |
| [marshal](marshal.md) | Pass-style serialization layer; smallcaps wire format. | 49 |
| [streams](streams.md) | Async-iterator-based stream abstraction; transport substrate. | 11 |
