...
| [exo](exo.md) | The Exo class API: `makeExo`, `defineExoClass`, `defineExoClassKit`. | 2 |
...
| [capability-security](capability-security.md) | Object-capability discipline as practiced in Endo / Agoric. | 7 |
...
| [pass-style](pass-style.md) | Marshal's classification system for how values cross a serialization boundary. | 18 |
