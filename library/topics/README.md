...
|-------|----------|----------|
| [agent-conventions](agent-conventions.md) | Repository-specific instructions written for AI agents working in a project. | 27 |
...
| [capability-security](capability-security.md) | Object-capability discipline as practiced in Endo / Agoric. | 112 |
...
| [daemon](daemon.md) | The Endo daemon: per-user persistent host for HardenedJS workers. | 45 |
...
| [patterns](patterns.md) | The @endo/patterns shape-matching language; method guards. | 25 |
