...
| [cap-talk-2009-2012--space-recovery-in-mutually-suspicious-systems](../sections/cap-talk-2009-2012--space-recovery-in-mutually-suspicious-systems.md) | cap-talk 2012-May | KeyKOS space banks (per-tenant storage budgets) versus mark-and-sweep: reclamation under mutual suspicion is an accounting property, not a graph-analysis one, because inspecting the object graph violates POLA. |
