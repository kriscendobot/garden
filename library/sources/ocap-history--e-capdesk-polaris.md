...
status: current
notes: |
  Survey synthesized from the library's already-ingested Miller papers
  (papers--miller-tribble-shapiro-concurrency-among-strangers-2005--history-and-related-work,
  papers--miller-tulloh-shapiro-structure-of-authority-2004--multiplicative-pola-and-security-as-modularity,
  papers--swasey-garg-dreyer-ocpl-2017--related-work-iris-foundation-and-future-firefox-membrane),
  Wikipedia on E programming language (en.wikipedia.org/wiki/E_(programming_language)),
  and the Waterken project page (waterken.sourceforge.net). erights.org itself was
...
Survey of the E programming language, CapDesk, and Polaris as the canonical first wave of working object-capability implementations, with a focus on what each demonstrated technically and why none achieved commercial adoption. Intended as the factual anchor for the B2 essay's "thirty-year history of technical success and market failure" objection, grounded in named sources rather than unsourced assertions.
...
- [combex--tech-index](combex--tech-index.md), [combex--edesk](combex--edesk.md), [combex--darpa-browser](combex--darpa-browser.md), and [combex--opportunity](combex--opportunity.md) — the **primary** CapDesk source cluster (fetched 2026-06-28 via the Internet Archive, `source_fetched_via=wayback`), of which this survey is the secondary-source market-history companion (job `scholar-ingest-source-combex-capdesk-polaris-primaries`). The Polaris primary in that cluster is the canonical [papers--stiegler-polaris-virus-safe-computing-2004](papers--stiegler-polaris-virus-safe-computing-2004.md) listed above (a second, duplicate ingest `papers--stiegler-karp-yee-miller-polaris-2004` was consolidated as superseded on 2026-06-28).
