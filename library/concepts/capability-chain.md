...
| [cap-talk-2009-2012--avoiding-excess-authority-in-chained-access](../sections/cap-talk-2009-2012--avoiding-excess-authority-in-chained-access.md) | Whether an intermediary should forward the caller's authority or use its own; Wagner's 2x3 matrix; Frantz on there being no single maximum facet; Miller's sealed-box designation. |
