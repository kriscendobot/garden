...
| [cap-talk 2012-12: capability enforcement — language, OS, or hardware](../sections/cap-talk-2009-2012--capability-enforcement-language-os-or-hardware.md) | Barbour's argument that authorization and authentication are symptoms, and the true basis for security is dataflow and modular structure — the language-up enforcement bet Endo makes. |
