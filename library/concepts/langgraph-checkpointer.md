...
| [short-term memory: thread persistence via the checkpointer](../sections/web--langchain-short-term-memory--checkpointer-thread-persistence.md) | LangChain short-term memory: a checkpointer makes thread history resumable by thread_id. |

## See also

- [[langgraph]] — the orchestration runtime the checkpointer serves.
- [[langgraph-store]] — the complementary long-term, cross-thread store.
