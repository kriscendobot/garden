...
| [Meese & Rogoff rolling protocol](../sections/papers--meese-rogoff-exchange-rate-models-seventies-1983--rolling-out-of-sample-protocol-and-error-metrics.md) | A 1973-81 expanding-window forecast experiment re-estimates models each month at one-, three-, six-, and twelve-month horizons. |
