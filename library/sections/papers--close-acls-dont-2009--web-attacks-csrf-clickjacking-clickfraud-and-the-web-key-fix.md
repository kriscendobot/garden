---
title: CSRF and clickjacking as Confused Deputy attacks on the Web; the §3.2.1 web-key fix (unguessable URLs as capability-by-reference, requiring no changes to Web protocols / formats / user agents / server infrastructure); click fraud as another instance of client-authentication-misled access decisions; the §4-§5 conclusion — many systems can migrate from ACL to capability with relatively minor changes
