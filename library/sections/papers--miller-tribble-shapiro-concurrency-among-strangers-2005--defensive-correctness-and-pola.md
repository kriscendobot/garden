---
title: Defensive Correctness, Defensive Consistency, and POLA (the statusGetter/statusSetter split; Pluribus)
...
- [[caretaker-pattern]] — the upstream-formalized construction the statusGetter/statusSetter split implements.
- [[principle-of-least-authority]] — newly drafted concept page covering POLA (this paper is the cited paper).
- [[object-capability]] — the model whose Property D (No Ambient Authority) makes POLA articulable in code rather than as a policy.
- [[delegates-and-epithets]] — the Endo construct that bundles per-vat keypair + Handle + HandleControl into one design.
- [[papers--miller-capability-myths-demolished-2003]] — the cited companion paper; §7's POLA aside cites MS03 (Paradigm Regained) and SS75 (Saltzer-Schroeder).
