...
- [Weak-Value-Map via `WeakRef` + `FinalizationRegistry` with gc-as-side-channel warning and end-of-turn stability](endo--packages-captp-src-finalize-js--weak-value-map-via-WeakRef-and-FinalizationRegistry-with-gc-as-side-channel-warning-and-end-of-turn-stability--weak-value-map-via-weakref-finalizationregistry-with-gc-as-side-channel-warning.md)
...
- [The §two-mode design — §graceful-fallback-via-fakeFinalizingMap](endo--packages-captp-src-finalize-js--weak-value-map-via-WeakRef-and-FinalizationRegistry-with-gc-as-side-channel-warning-and-end-of-turn-stability--the-two-mode-design-graceful-fallback-via-fakefinalizingmap.md)
...
- [The §end-of-turn stability invariant](endo--packages-captp-src-finalize-js--weak-value-map-via-WeakRef-and-FinalizationRegistry-with-gc-as-side-channel-warning-and-end-of-turn-stability--the-end-of-turn-stability-invariant.md)
...
- [The §clearWithoutFinalizing-exempt semantics](endo--packages-captp-src-finalize-js--weak-value-map-via-WeakRef-and-FinalizationRegistry-with-gc-as-side-channel-warning-and-end-of-turn-stability--the-clearwithoutfinalizing-exempt-semantics.md)
...
- [How this file fits the @endo/captp cluster](endo--packages-captp-src-finalize-js--weak-value-map-via-WeakRef-and-FinalizationRegistry-with-gc-as-side-channel-warning-and-end-of-turn-stability--how-this-file-fits-the-endo-captp-cluster.md)
- [Related sections](endo--packages-captp-src-finalize-js--weak-value-map-via-WeakRef-and-FinalizationRegistry-with-gc-as-side-channel-warning-and-end-of-turn-stability--related-sections.md)
