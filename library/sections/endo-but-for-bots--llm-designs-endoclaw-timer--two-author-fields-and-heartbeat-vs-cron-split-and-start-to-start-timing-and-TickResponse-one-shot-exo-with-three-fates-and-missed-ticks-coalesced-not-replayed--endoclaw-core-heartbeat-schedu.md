---
title: "EndoClaw: Core Heartbeat Scheduler — two Author fields + heartbeat-vs-cron split + start-to-start timing + TickResponse one-shot exo with three fates + missed-ticks coalesced not replayed + ten Design Decisions"
