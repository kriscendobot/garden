---
title: Rights as Property and Money as an Electronic Right (decentralized rights vs governance; ocap as property-rights strategy; four dimensions where money differs from references; the makeMint code in JavaScript)
...
- [[mint-purse-money]] — the canonical concept page. The §4 of this paper is the JavaScript enactment of the 2000 §3.4 pattern; both should be cited together.
- [[brand-and-trademark]] — WeakMap as JavaScript-native brand primitive; the canonical citation for *contemporary brand discipline*.
- [[principle-of-least-authority]] — §3.2's possessory-rights framing is the structural-architectural justification for POLA at the rights-transfer layer.
- [[smart-contract]] — §3's *rights are partitions of action space; smart contracts manipulate rights* is the architectural framing.
- [[agoric-system]] — the broader framework. This 2013 paper is one of the most-directly-Agoric of the Miller-coauthored papers; Agoric ERTP is the production realization.
- `papers--miller-morningstar-frantz-capability-based-financial-instruments-2000--mint-purse-money-and-six-security-properties` — the 2000 paper's mint-purse-money example reappears here in JavaScript.
- `papers--miller-morningstar-frantz-capability-based-financial-instruments-2000--pluribus-rights-taxonomy-and-covered-call-option` — the 2000 paper's four-axis rights taxonomy is reapplied here in §3.3.
