---
title: "garden/journal/jobs/README.md — eleventh garden source; §eleven-cycles-with-garden-repo-source-ingest; §eleven-named-shapes-of-garden-self-documentation; §the-named-job-board-contract (the eleventh named shape); §the-named-fourth-design-and-instance-pair-across-the-garden-cluster (cycles 299 CLAUDE.md + 303 liaison AGENT.md named the contract + cycle 306 IS the contract); §two-cycles-with-named-journal-branch-source (305 + 306); §two-named-contract-and-procedure-pairs (305 + 306); §four-cycles-with-6-hex-short-id-discipline (297 + 298 + 301 + 306); §the-named-claim-race-resolution-via-git-push; §the-named-flat-board-vs-per-role-board; §the-named-stale-reference-witness (README pre-dates 2026-06-03 general-contractor retirement)"
...
# `garden/journal/jobs/README.md` (eleventh garden source ingest)

A 143-line document — the job-board contract. **The eleventh garden source ingested**. **The second journal-branch source** (after cycle 305's conventions.md). **§eleven-cycles-with-garden-repo-source-ingest** (281 designs/driver.md + 297 WORKTREES.md + 298 dispatch-prepare/teardown pair + 299 CLAUDE.md + 300 daemons start/stop/config-example + 301 roles/COMMON.md + 302 skills/library-lookup/SKILL.md + 303 roles/liaison/AGENT.md + 304 scripts/watcher/endo-but-for-bots/watcher.sh + 305 journal/library/conventions.md + 306 journal/jobs/README.md). **§eleven-named-shapes-of-garden-self-documentation** (proposed-design + standing-reference + implementation-source + project-instructions + operational-daemon-control + standing-subagent-instructions + skill-procedural-playbook + role-specific-orchestrator-instructions + per-feed-watcher-stub + library-conventions + job-board-contract).

**§the-named-fourth-design-and-instance-pair-across-the-garden-cluster**: cycle 299 CLAUDE.md named "contract at [`journal/jobs/README.md`](journal/jobs/README.md)"; cycle 303 liaison AGENT.md named "See `journal/jobs/README.md` for the board's contract"; cycle 306 IS that contract. **§four-named-design-and-instance-pairs-across-the-garden-cluster** (299→301 + 301→302 + 302→305 + (299+303)→306). **§the-named-multi-cycle-claim-IS-realized-in-cycle-306**: this IS the second claim with multiple naming cycles converging on a single realization (extends cycle 304's named-quadruple-claim-and-single-realization).

**§two-cycles-with-named-journal-branch-source**: cycle 305 conventions.md + cycle 306 jobs/README.md. The cross-branch cluster grows from one to two. **§the-named-cross-branch-cluster-extends**.

**§two-named-contract-and-procedure-pairs**: cycle 305 (conventions.md spec + cycle 302 library-lookup SKILL.md procedure) + cycle 306 (jobs/README.md contract + skills/job-board/SKILL.md procedure, the latter named but not yet ingested). **§the-named-spec-and-procedure-pair-shape-extends**.
...
- **§eleven-cycles-with-garden-repo-source-ingest**: 281 + 297 + 298 + 299 + 300 + 301 + 302 + 303 + 304 + 305 + 306.
- **§eleven-named-shapes-of-garden-self-documentation**: proposed-design + standing-reference + implementation-source + project-instructions + operational-daemon-control + standing-subagent-instructions + skill-procedural-playbook + role-specific-orchestrator-instructions + per-feed-watcher-stub + library-conventions + job-board-contract.
- **§two-cycles-with-named-journal-branch-source**: 305 + 306.
- **§four-named-design-and-instance-pairs-across-the-garden-cluster**: 299→301 + 301→302 + 302→305 + (299+303)→306.
- **§the-named-double-claim-and-single-realization**: cycles 299 + 303 both named jobs/README.md as the contract; cycle 306 realizes it. Companion to cycle 304's named-quadruple-claim-and-single-realization.
- **§two-named-contract-and-procedure-pairs**: cycle 305 (conventions + library-lookup) + cycle 306 (jobs/README + job-board SKILL).
- **§three-cycles-with-named-git-push-as-the-serialization-point**: 299 + 301 + 306.
- **§three-cycles-with-named-2026-05-18-channel-split-or-equivalent**: 299 + 303 + 306.
- **§two-cycles-with-named-back-off-without-retry**: 299 + 306.
- **§two-cycles-with-named-act-vs-read-discrimination-question**: 303 + 306.
- **§four-cycles-with-6-hex-short-id-discipline**: 297 + 298 + 301 + 306.
- **§two-cycles-with-named-30-second-default-daemon-cadence**: 304 + 306.
- **§three-cycles-with-named-bash-daemon-owned-state-survives-LLM-ticks**: 301 + 304 + 306.
- **§two-cycles-with-named-bash-daemon-state-locations**: 304 (.garden-monitor/) + 306 (/tmp/garden-jobs.*).
- **§two-cycles-with-named-where-things-are-section**: 301 + 306.
- **§three-cycles-with-design-pointer-back-to-driver-design**: 281 designs/driver.md + 304 watcher + 306 jobs/README.
- **§the-named-eleven-cycle-bridge**: 296 + 297 + 298 + 299 + 300 + 301 + 302 + 303 + 304 + 305 + 306.

## Notes

- Cycle 306 IS the **second journal-branch source** in the garden cluster (after cycle 305's conventions.md). **§the-named-cross-branch-cluster-extends**.
- The fourth design-and-instance pair (299+303→306) IS the first **double-claim** instance: two prior cycles both named the same target document; cycle 306 IS the single realization. Companion to cycle 304's quadruple-claim shape. **§the-named-claim-multiplicity-variation**: realizations can be claimed by one, two, three, or four prior cycles.
- The README still references **general-contractor** as a consumer role; cycle 299 CLAUDE.md named the 2026-06-03 retirement. **§the-named-stale-reference-witness**: the document pre-dates the retirement. A future scholar cycle could add a `status: stale` flag or a notes pointer to the retirement entry; for the librarian's purposes the stale reference IS itself documented evidence of named-organic-growth-and-named-document-drift.
- The named-distributed-work-queue shape and the named-git-push-as-serialization-point form together the named-no-Redis-no-PostgreSQL-no-Kafka claim from cycle 299 — the garden uses git's built-in primitives for all coordination. **§the-named-zero-dependency-coordination-IS-named-realized-in-the-jobs-board-implementation**.
- The named-three-cycle-property-procedure-rationale-chain shape from cycle 305 has a parallel here: cycle 299 CLAUDE.md named the property (two-channel-message-bus); cycle 303 liaison AGENT.md IS the procedural framing (with vocabulary tables); cycle 306 IS the contract (the data layer). **§the-named-three-cycle-property-procedure-data-chain** (299 + 303 + 306). This IS distinct from cycle 305's chain (which was 301 + 302 + 305): cycle 305 chain was property→procedure→rationale; cycle 306 chain IS property→procedure→data. **§two-named-three-cycle-chains-with-distinct-third-position-roles** (rationale vs data).
