...
status: superseded
superseded_by: papers--stiegler-polaris-virus-safe-computing-2004--designation-as-authorization-powerbox-and-installation-endowment
...
superseded_reason: |
  ...
  the concepts/polaris.md and concepts/powerbox.md concept pages. This section's
  designation/PowerBox/installation-endowment content is covered by the canonical
  designation-as-authorization section, and its Pets/visual-cues content by the
  canonical polarizing-applications section. Kept, not deleted: the journal is
  append-only.
---
