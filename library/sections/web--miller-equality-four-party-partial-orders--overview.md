...
Source: [Four Party Partial Orders](https://erights.org/elib/equality/after-both.html), Mark S. Miller, erights.org; ingested from the Internet Archive original-bytes capture, content SHA-256 `e9e89167`.
