...
Source: [The Grant Matcher Puzzle](https://erights.org/elib/equality/grant-matcher/index.html), Mark S. Miller, erights.org (mirrored at [caplet.com](http://www.caplet.com/security/taxonomy/grant-match/grant-matcher.html)); fetched 2026-06-27 via the erights.github.io GitHub Pages mirror, content SHA-256 `d25136c9` (byte-identical to the prior Internet-Archive capture).
