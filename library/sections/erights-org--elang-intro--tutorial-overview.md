...
source: elang/intro/index.html
source_repo: erights.org (GitHub Pages mirror erights.github.io/erights-org-website)
...
status: current
notes: Primary erights.org source for the E language's pedagogy, reachable again via the GitHub Pages mirror; grounds the previously secondary-source-synthesized ocap-history--e-capdesk-polaris survey.
---
