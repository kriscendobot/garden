---
title: How OCPL builds on Iris (concurrent separation logic with higher-order ghost state + step-indexed Kripke models); the comparison to Devriese et al 2016 Kripke logical relations (predecessor) and Drossopoulou et al 2015a/b Hoare-logic (cycle-85 paper, complementary); the related-work survey citing cycles 82, 85, 91 ingests; the ownership-types comparison (Clarke 1998 owners-as-dominators; Banerjee-Naumann; Patrignani et al join-calculus); the Coq mechanization at plv.mpi-sws.org/iris/; the Firefox same-origin-policy membrane as future-work direction
...
- [[capability-theory]] (topic) — OCPL is the third formal-foundation paper in the capability-theory cluster (after cycle-85 Drossopoulou and cycle-91 Taly).
- [[capability-security]] (topic) — OCPL's three OCPs map to contemporary capability-security patterns.
- [[hardened-javascript]] (topic) — HardenedJS is the contemporary realization of OCPL's HLA-language-of-OCPs.
- `papers--swasey-garg-dreyer-ocpl-2017--hla-language-program-logic-and-robust-safety` — the first section: OCPL's foundation.
- `papers--swasey-garg-dreyer-ocpl-2017--three-ocps-verified-dynamic-sealing-caretaker-membrane` — the second section: the three OCPs verified.
- `papers--drossopoulou-reasoning-about-risk-and-trust-2015--*` — the cycle-85 paper this paper cites and extends.
- `papers--taly-automated-analysis-of-security-critical-javascript-apis-2011--*` — the cycle-91 paper this paper cites as related work.
- `papers--miller-vancutsem-tulloh-distributed-electronic-rights-2013--*` — the cycle-82 paper; OCPL's caretaker + membrane patterns underlie the Dr. SES + Contract Host design.
