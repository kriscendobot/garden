---
title: "garden/journal/library/conventions.md — tenth garden source; §ten-cycles-with-garden-repo-source-ingest; §ten-named-shapes-of-garden-self-documentation; §the-named-library-conventions-shape (the tenth named shape); §the-named-cross-branch-garden-cluster (first journal-branch source after nine main-branch); §the-named-third-design-and-instance-pair-across-the-garden-cluster (cycle 302 named conventions.md as the spec + cycle 305 IS the spec); §the-named-three-source-kinds (repo + paper + comment-fragment with named source_kind discriminant); §four-named-status-values-for-sections; §twenty-named-topic-slugs-in-the-seed-taxonomy; §eight-named-ingestion-steps; §the-named-three-vs-four-writeback-actions-distinction (conventions names three; library-lookup SKILL.md names four including 4d queue); §six-named-PDF-sources-in-priority-order; §the-named-three-cycle-property-procedure-rationale-chain (301 property + 302 procedure + 305 rationale)"
...
# `garden/journal/library/conventions.md` (tenth garden source ingest)

A 483-line document — the library ingestion conventions. **The tenth garden source ingested**. **§ten-cycles-with-garden-repo-source-ingest** (281 designs/driver.md + 297 WORKTREES.md + 298 dispatch-prepare/teardown pair + 299 CLAUDE.md + 300 daemons start/stop/config-example + 301 roles/COMMON.md + 302 skills/library-lookup/SKILL.md + 303 roles/liaison/AGENT.md + 304 scripts/watcher/endo-but-for-bots/watcher.sh + 305 journal/library/conventions.md). **§ten-named-shapes-of-garden-self-documentation** (proposed-design + standing-reference + implementation-source + project-instructions + operational-daemon-control + standing-subagent-instructions + skill-procedural-playbook + role-specific-orchestrator-instructions + per-feed-watcher-stub + library-conventions).

**§the-named-cross-branch-garden-cluster**: cycles 281-304 all sourced from the garden's **main** branch; cycle 305 IS the first cycle to source from the garden's **journal** branch (the orphan branch holding the journal's worktree). The garden cluster IS now multi-branch. **§the-named-multi-branch-self-documentation-shape**.

**§the-named-third-design-and-instance-pair-across-the-garden-cluster**: cycle 302's library-lookup SKILL.md named "For the data structure see `journal/library/conventions.md` § *Concepts and the keyword index*"; cycle 305 IS that document. **§three-named-design-and-instance-pairs-across-the-garden-cluster** (299→301 + 301→302 + 302→305). **§the-named-pattern-of-pattern-extends-to-three-instances**.
...
- **§ten-cycles-with-garden-repo-source-ingest**: 281 + 297 + 298 + 299 + 300 + 301 + 302 + 303 + 304 + 305.
- **§ten-named-shapes-of-garden-self-documentation**: proposed-design + standing-reference + implementation-source + project-instructions + operational-daemon-control + standing-subagent-instructions + skill-procedural-playbook + role-specific-orchestrator-instructions + per-feed-watcher-stub + library-conventions.
- **§the-named-cross-branch-garden-cluster**: nine main-branch sources + one journal-branch source (cycle 305).
- **§three-named-design-and-instance-pairs-across-the-garden-cluster**: 299→301 + 301→302 + 302→305.
- **§three-cycles-with-named-three-indexing-axes**: 301 + 302 + 305.
- **§three-cycles-with-named-append-only-discipline**: 301 + 302 + 305.
- **§two-cycles-with-named-pipe-delimited-keyword-row-shape**: 302 + 305.
- **§two-cycles-with-named-backticks-for-code-symbols-discipline**: 302 + 305.
- **§two-cycles-with-named-grepped-not-read-discipline**: 302 + 305.
- **§two-cycles-with-named-skill-mediated-access**: 302 + 305.
- **§two-cycles-with-named-canonical-example-crdt-in-formula-persistence**: 302 + 305.
- **§the-named-three-cycle-property-procedure-rationale-chain**: 301 (named-property) + 302 (procedural-realization) + 305 (explanatory-rationale).
- **§the-named-ten-cycle-bridge**: 296 + 297 + 298 + 299 + 300 + 301 + 302 + 303 + 304 + 305.
- **§the-named-WORKTREES-design-pointer-to-journal-implementation**: 297 + 305.
- **§the-named-pattern-of-pattern-extends-to-three-instances**: three named design-and-instance pairs now.

## Notes

- Cycle 305 IS the **first journal-branch source** in the garden cluster. Branch-shape extension: nine main + one journal. **§the-named-multi-branch-self-documentation-shape**.
- The conventions document IS the spec for the very library this cycle extends. **§the-named-self-referential-shape-at-the-spec-level**: the conventions describe how the library should be organized; this section file IS itself an instance of the section-file shape the conventions name.
- The named-three-cycle-property-procedure-rationale-chain (301 + 302 + 305) IS a new compound pattern: cycle 301 named the property of compounding library improvement; cycle 302 IS the procedure that realizes the property; cycle 305 IS the rationale that explains why the property matters. **§the-named-three-angle-coverage-shape**.
- The named-eleven-named-section-frontmatter-fields IS the conventions' explicit prescription. The section files this cycle produces (and the source page) follow that prescription as a self-consistency check.
- The named-three-source-kinds (repo + paper + comment-fragment) IS the conventions' explicit schema-evolution shape. The discriminant via `source_kind:` IS named-anti-divergence: future schema additions stay backward-compatible.
- The named-anti-taxonomy-proliferation-discipline ("do **not** invent a new `status:` value") IS the conventions' discipline of preferring the union of two existing fields over a third taxonomy value.
- The named-three-vs-four-writeback-actions-distinction: cycle 302's library-lookup SKILL.md counts FOUR writebacks (including 4d queue-scholar-review); cycle 305's conventions.md counts THREE. The discrepancy IS NOT a contradiction — conventions names 4d as a downstream consequence (one missive per cycle, not per page), while the skill counts it as a discrete action. **§the-named-counting-discrepancy-IS-named-discrepancy-in-counting-not-substance**.
