...
Revisions: main2 `1f97b707f08a`; journal2 `0e79fc893d33`.

## main2 context library

Reachable documents: 223. Reorganization candidates: 34.
...
| `skills/local-verify/SKILL.md` | 318 | 17824 | large | 14 |
| `skills/job-board/SKILL.md` | 284 | 17605 | medium | 7 |
| `skills/at-mention-surveillance/SKILL.md` | 284 | 15677 | medium | 8 |
| `references/endo-but-for-bots/roles/chronicler.md` | 284 | 14138 | medium | 6 |
...
- `skills/local-verify/SKILL.md` (318 lines, 17.4 KiB): at least 300 lines; 2.7x the sibling median (116 lines); 14 level-two sections suggest mixed topics.
...
- `context/operations/starting.md` (268 lines, 13.7 KiB): 2.6x the sibling median (102 lines).
...
| Path | Lines | Bytes | Class | Level-two sections |
| --- | ---: | ---: | --- | ---: |
| `README.md` | 6917 | 668166 | very large | 8 |

### Reorganization candidates

- `README.md` (6917 lines, 652.5 KiB): at least 300 lines; at least 24 KiB; 8 level-two sections suggest mixed topics.

## Orphan signal

Unreachable tracked Markdown documents: 36 on main2 and 190 under journal2 `library/`.
...
### journal2 context orphans (showing 50 of 190)
...
- `library/endo-but-for-bots/TADA/51_genie_dev_repl_local_sandbox_powers.md`

## Summary

Walked 8194 reachable documents and flagged 302 reorganization candidates.
