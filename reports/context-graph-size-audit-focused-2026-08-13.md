...
This report walks relative inline Markdown links from the documented context roots. The main2 roots are the top-level orientation documents plus every role, juror, skill, design, and `context/` Markdown document. Excluded main2 globs (dropped as roots and pruned from the walk, so they are neither seeded nor reached through links): `designs/*.md`. The journal2 roots are `README.md`, `library/README.md`; links from those roots may reach additional journal trees. Excluded journal2 seeds: `projects/README.md`.
...
Revisions: main2 `ce552548d3fb`; journal2 `111c7aeb491a`.

## main2 context library

Reachable documents: 213. Reorganization candidates: 33.
...
| `README.md` | 419 | 26775 | large | 3 |
| `skills/native-customizable-form-control-styling/SKILL.md` | 400 | 19999 | large | 13 |
| `skills/css-anchor-positioning-and-flip-fallbacks/SKILL.md` | 393 | 20631 | large | 11 |
| `references/endo-but-for-bots/CLAUDE.md` | 388 | 18703 | large | 11 |
| `skills/pr-creation-flow/SKILL.md` | 376 | 21443 | large | 16 |
| `roles/liaison/AGENT.md` | 366 | 24069 | large | 8 |
| `skills/ci-failure-classification-loop/SKILL.md` | 340 | 17527 | large | 11 |
| `skills/frozen-base-branch/SKILL.md` | 339 | 15818 | large | 12 |
| `CLAUDE.md` | 321 | 41017 | large | 10 |
| `skills/job-board/SKILL.md` | 284 | 17605 | medium | 7 |
| `skills/at-mention-surveillance/SKILL.md` | 284 | 15677 | medium | 8 |
...
- `README.md` (419 lines, 26.1 KiB): at least 300 lines; at least 24 KiB.
...
Reachable documents: 2. Reorganization candidates: 1.

### Largest 2 documents

| Path | Lines | Bytes | Class | Level-two sections |
| --- | ---: | ---: | --- | ---: |
| `projects/finbot/financial-forecasting-literature-review.md` | 152 | 26188 | large | 7 |
| `projects/finbot/README.md` | 29 | 2720 | small | 5 |
...
| Path | Lines | Bytes | Class | Level-two sections |
| --- | ---: | ---: | --- | ---: |
| `README.md` | 6911 | 667423 | very large | 8 |

### Reorganization candidates

- `README.md` (6911 lines, 651.8 KiB): at least 300 lines; at least 24 KiB; 8 level-two sections suggest mixed topics.

## Orphan signal

Unreachable tracked Markdown documents: 36 on main2 and 8 under journal2 `library/`.
...
### journal2 context orphans (showing 8 of 8)
...
Walked 8184 reachable documents and flagged 301 reorganization candidates.
