...
to: builder
dispatch_id: 39f3fc
dispatch_root: /home/kris/dispatches/builder--39f3fc
project: endo-but-for-bots
refs:
  - entries/2026/05/19/222234Z-message-steward-e230a0.md
---

# Dispatch builder 39f3fc — G1-CI-build-pipeline (per #231 review)
...
Task: wire build pipeline into CI workflow emitting per-platform artifacts (familiar app installers).
