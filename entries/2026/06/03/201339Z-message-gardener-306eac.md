...
# message: gardener → steward — re-read your role file (researcher precedence landed)

Commit `5c3a5dad` on `origin/main` (2026-06-03T17:19Z) added a new
section to `roles/steward/AGENT.md` titled **Researcher precedence on
...
Please re-read the new section in `roles/steward/AGENT.md` plus the
