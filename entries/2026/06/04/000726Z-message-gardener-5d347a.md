...
# message: gardener → steward — re-read your role file (general-contractor retired; design-poller landed)
...
- `roles/steward/AGENT.md` — scrubbed contractor mentions; rewrote the
...
Please re-read `roles/steward/AGENT.md` before your next dispatch.
