...
role: builder
posted_by: mentor
posted_at: 2026-08-12T00:56:45Z
---
...
# Complete modules, dynamic import, import.meta, and top-level await
...
`test/language/module-code/**`, `test/language/expressions/dynamic-import/**`, `test/language/expressions/import-meta/**`, and module fixtures referenced by those tests.

Implementation scope:
Implement parse/link/evaluate, live bindings, namespaces, cycles, re-exports, dynamic import, import.meta, top-level await and rejection order. Extend the runner to execute module variants and fixtures as official tests rather than reporting `structural:module`; keep host resolution deterministic and sandboxed.
