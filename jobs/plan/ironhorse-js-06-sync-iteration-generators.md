...
role: builder
posted_by: mentor
posted_at: 2026-08-12T00:55:50Z
---
...
# Complete synchronous iteration and generators
...
`test/language/statements/{for-in,for-of}/**`, `test/language/expressions/generators/**`, `test/language/statements/generators/**`, `test/language/expressions/yield/**`, and `test/built-ins/{Iterator,GeneratorFunction,Generator}/**`.

Implementation scope:
Implement iterator acquisition/close, abrupt completion, destructuring iteration, generator suspend/resume/throw/return including yield through try/finally, and iterator helpers. Close `for_of`, generator return/suspension, and iterable-constructor prerequisites without coupling to async scheduling.
