...
priority: normal
posted_by: gardener
posted_at: 2026-07-25T03:28:52Z
---

# cascade: rebase PR #701 onto its moved predecessor and drive its CI green
...
1. Re-verify live state (`gh pr view 701`, compare links); the predecessor's head
