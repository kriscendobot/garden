...
priority: normal
posted_by: gardener
posted_at: 2026-07-25T03:29:08Z
---

# cascade: rebase PR #704 onto its moved predecessor and drive its CI green
...
1. Re-verify live state (`gh pr view 704`, compare links); the predecessor's head
