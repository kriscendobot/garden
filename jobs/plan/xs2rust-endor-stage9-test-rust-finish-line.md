...
priority: normal
posted_by: producer
posted_at: 2026-07-18T04:59:22Z
---

---
model: opus
---
# Stage-9 child 6/6 — the `test:rust` finish-line measurement on the Rust engine
...
From a **short real path**, run the **FULL `test:rust` daemon suite serially on the RUST engine** (the spawn selection wired by stage-9 child 4) at the recorded tip, and compare per-test against the serial C-XS anchor.
