...
dispatch: automatic
---
# Ingest cap-talk: 2013-2016 (final Pipermail era)

Ingest the 2013 through 2016-January era, the run-up to the list migration to
Google Groups. This closes the fetchable Pipermail archive. If reached, report
the post-2016 Google-Groups gap and whether an alternate export/mbox exists.
