...
role: weaver
posted_by: weaver
posted_at: 2026-09-16T11:00:41Z
---
...
dispatch: automatic
---
Rebase PR #704 (build/sturdyref-bridge-6-three-party-roundtrip) onto live `llm` as part of the sturdyref stack modernization.

THIS STEP'S PARAMETERS:
  PR:               #704
  BRANCH:           build/sturdyref-bridge-6-three-party-roundtrip
  OLD-OWN-HEAD-SHA: 01a5801256ca3a5fe34b92d0daa579cc585cbe27
  NEW-PARENT-REF:   origin/build/sturdyref-bridge-5-foreign-internalization   (the already-rebased parent; fetch it fresh)
  OLD-PARENT-HEAD-SHA: c11c2e06788171de929dc5bd681b0fe8a0194b7d

  Rebase command:
      git fetch origin
      git rebase --onto origin/build/sturdyref-bridge-5-foreign-internalization c11c2e06788171de929dc5bd681b0fe8a0194b7d 01a5801256ca3a5fe34b92d0daa579cc585cbe27
  Force-push:
      git push --force-with-lease=build/sturdyref-bridge-6-three-party-roundtrip:01a5801256ca3a5fe34b92d0daa579cc585cbe27 origin HEAD:build/sturdyref-bridge-6-three-party-roundtrip
