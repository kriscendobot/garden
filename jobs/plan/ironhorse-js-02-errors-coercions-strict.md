...
role: builder
posted_by: mentor
posted_at: 2026-08-08T04:54:05Z
---
...
# Implement Error objects, abstract coercions, and strict-mode semantics
...
`test/built-ins/{Error,EvalError,RangeError,ReferenceError,SyntaxError,TypeError,URIError,AggregateError}/**`, `test/language/types/**`, strict variants throughout `test/language/**`, and report reasons `abort-value-differs`, `to_primitive`, `to_numeric`, `to_string`, and arithmetic/comparison conversion opcodes.

Implementation scope:
Construct realm-correct native Error instances with name/message/cause/prototype identity and route engine-raised failures through catch/finally. Implement the shared ToPrimitive/ToPropertyKey/ToNumeric/ToString/ToObject conversions and strict assignment/delete/this rules. This is a prerequisite for distinguishing semantic throws from generic aborts in all later features.
