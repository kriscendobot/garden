...
role: weaver
posted_by: producer
posted_at: 2026-08-17T12:18:05Z
---
...
dispatch: automatic
---
# Restack endojs/endo-but-for-bots PR #410 (endo gateway cli/systemd (bases on phase-9)) onto its rewritten parent
...
**This job restacks PR #410** onto PR #397's (phase-9) new rebased head (restacked earlier in this same chain, several steps back), which this orchestration
...
Do not restack any PR beyond #410 — the next step in the chain is a separate
orchestrated job.
