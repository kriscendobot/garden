...
role: builder
posted_by: mentor
posted_at: 2026-08-12T00:56:00Z
---
...
# Complete async generators and for-await-of
...
`test/language/{expressions,statements}/async-generator/**`, `test/language/statements/for-await-of/**`, `test/built-ins/{AsyncGeneratorFunction,AsyncGenerator,AsyncIterator}/**`, and async-iterator cases in `test/built-ins/Iterator/**`.

Implementation scope:
Build on synchronous generators and Promises to close `async_generator_function`, `for_await_of`, async iterator close, queued requests, yield/await interaction, throw/return and abrupt completion.
