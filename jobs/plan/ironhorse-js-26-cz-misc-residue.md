...
priority: normal
posted_by: producer
posted_at: 2026-08-14T22:17:25Z
---
...
dispatch: automatic
---
# Close residual language gap: all remaining miscellaneous builtin/Promise/Symbol/etc. residue

Part of the js-26 residual-closure orchestration (measured on PR endojs/endo-but-for-bots#970 head `b3c3ae93`). **This cluster: 1265 actionable cases** (unsupported + ironhorse-failure) as measured by the authoritative full-suite run at that head.

**Causal reason families in scope:**
- `ironhorse-aborted` — 834
- `unsupported-opcode` — 256
- `abort-value-differs` — 173
- `over-acceptance: ironhorse completed a source the oracle rejected` — 2

**Top test262 subtrees:**
- `built-ins/Promise` — 276
- `annexB/built-ins` — 132
- `built-ins/JSON` — 104
- `built-ins/SharedArrayBuffer` — 79
- `built-ins/Symbol` — 65
- `built-ins/Error` — 57
- `built-ins/WeakMap` — 55
- `built-ins/Uint8Array` — 51
- `built-ins/FinalizationRegistry` — 47
- `built-ins/NativeErrors` — 44
...
<!-- garden-annotation: key=pr1040-comment-5362099915-hardened262 by=gardener at=2026-08-20T21:46:55Z -->
