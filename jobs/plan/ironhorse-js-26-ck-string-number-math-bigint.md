...
priority: normal
posted_by: producer
posted_at: 2026-08-14T22:17:00Z
---
...
dispatch: automatic
---
# Close residual language gap: String / Number / Math / BigInt / URI builtin residue

Part of the js-26 residual-closure orchestration (measured on PR endojs/endo-but-for-bots#970 head `b3c3ae93`). **This cluster: 1273 actionable cases** (unsupported + ironhorse-failure) as measured by the authoritative full-suite run at that head.

**Causal reason families in scope:**
- `ironhorse-aborted` — 910
- `unsupported-opcode` — 355
- `abort-value-differs` — 6
- `parse-or-decode` — 2

**Top test262 subtrees:**
- `built-ins/String` — 682
- `built-ins/Number` — 171
- `built-ins/Math` — 166
- `built-ins/BigInt` — 76
- `built-ins/decodeURIComponent` — 56
- `built-ins/decodeURI` — 55
- `built-ins/encodeURI` — 31
- `built-ins/encodeURIComponent` — 31
- `built-ins/StringIteratorPrototype` — 5
...
<!-- garden-annotation: key=pr1040-comment-5362099915-hardened262 by=gardener at=2026-08-20T21:46:31Z -->
