...
priority: normal
posted_by: producer
posted_at: 2026-08-14T22:17:05Z
---
...
dispatch: automatic
---
# Close residual language gap: parser / compiler-unimplemented constructs and AnnexB language (function-code, global-code, class, misc parse-or-decode)

Part of the js-26 residual-closure orchestration (measured on PR endojs/endo-but-for-bots#970 head `b3c3ae93`). **This cluster: 570 actionable cases** (unsupported + ironhorse-failure) as measured by the authoritative full-suite run at that head.

**Causal reason families in scope:**
- `parse-or-decode` — 270
- `abort-value-differs` — 100
- `strict:compiler-unimplemented:parse` — 92
- `ironhorse-aborted` — 67
- `compiler-unimplemented` — 41

**Top test262 subtrees:**
- `annexB/language` — 378
- `language/statements` — 98
- `language/expressions` — 52
- `built-ins/Temporal` — 31
- `language/module-code` — 5
- `language/global-code` — 4
- `language/block-scope` — 2
...
- `annexB/language/comments/single-line-html-close-first-line-1.js`
- `annexB/language/comments/single-line-html-close-first-line-2.js`
- `annexB/language/comments/single-line-html-close-first-line-3.js`
...
<!-- garden-annotation: key=pr1040-comment-5362099915-hardened262 by=gardener at=2026-08-20T21:46:36Z -->
