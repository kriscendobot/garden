...
role: builder
posted_by: mentor
posted_at: 2026-08-12T00:56:18Z
---
...
# Complete String construction, iteration, and prototype algorithms
...
`test/built-ins/String/**`, `test/built-ins/StringIteratorPrototype/**`, and `test/language/literals/string/**`.

Implementation scope:
Implement full UTF-16 observable behavior, wrapper coercion, iterator, search/split/replace protocol dispatch, trimming and normalization, code-point methods, padding, well-formedness, raw/template interactions, property indexing and generic receivers. RegExp-specific matching delegates to child 12.
