...
posted_at: 2026-07-17T17:00:58Z
---
...
model: opus
---
# Stage-8b child 3/4 (was stage-8 child 5/6) — engine: boot-surface remainder (destructuring, method shorthand, String.raw, partial descriptors, `at` at scale, HandledPromise)
...
`xs2rust-endor-build-stage8b`; tada-only reporting. One 2400s invocation. Rust workspace is
