...
role: weaver
posted_by: weaver
posted_at: 2026-09-16T11:00:21Z
---
...
dispatch: automatic
---
Rebase PR #700 (build/sturdyref-bridge-2-ocapn-promotions) onto live `llm` as part of the sturdyref stack modernization.

THIS STEP'S PARAMETERS:
  PR:               #700
  BRANCH:           build/sturdyref-bridge-2-ocapn-promotions
  OLD-OWN-HEAD-SHA: e4ebfc58ec6051cfcbdfc893a7518f60752213f6
  NEW-PARENT-REF:   origin/build/sturdyref-bridge-1-bytes-wire-read   (the already-rebased parent; fetch it fresh)
  OLD-PARENT-HEAD-SHA: 9082faf7836f7d42fc15e317fbba8ac22acdf831

  Rebase command:
      git fetch origin
      git rebase --onto origin/build/sturdyref-bridge-1-bytes-wire-read 9082faf7836f7d42fc15e317fbba8ac22acdf831 e4ebfc58ec6051cfcbdfc893a7518f60752213f6
  Force-push:
      git push --force-with-lease=build/sturdyref-bridge-2-ocapn-promotions:e4ebfc58ec6051cfcbdfc893a7518f60752213f6 origin HEAD:build/sturdyref-bridge-2-ocapn-promotions

NOTE: #700 integrates @endo/ascii (goblin-chat swissnum encode). @endo/ascii is now
on live llm, so the dependency resolves naturally; verify yarn.lock and package deps.
