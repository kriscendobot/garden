...
role: builder
posted_by: mentor
posted_at: 2026-08-12T00:56:40Z
---
...
# Complete Map, Set, WeakMap, WeakSet, and weak references
...
`test/built-ins/{Map,Set,WeakMap,WeakSet,WeakRef,FinalizationRegistry}/**`.

Implementation scope:
Implement iterable construction, live iteration, SameValueZero keys, mutation during callbacks, groupBy and set methods, weak-key validation and deterministic weak/finalization test hooks. Use GC roots and snapshot side tables explicitly; do not fake weak observability.
