...
# Gauntlet stage: FIX round 2 — endojs/endo-but-for-bots PR #1014

You are ONE stage of a staged gauntlet (endojs-endo-but-for-bots-pr286-cli-verb-rework-gauntlet). Apply the panel's must-fix items ONCE,
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh endojs-endo-but-for-bots-pr286-cli-verb-rework-gauntlet-fix-2 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
2. Read the LATEST panel verdict on https://github.com/endojs/endo-but-for-bots/pull/1014 (the request-changes `gh pr review` the
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-17T10:03:13Z
