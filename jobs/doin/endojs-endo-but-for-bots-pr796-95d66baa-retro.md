...
tier: mentor
---
<!-- garden-promoted-from-plan: gate=deferred priority=low at=2026-08-22T05:57:09Z cleared=none -->
...
dispatch: automatic
---
# Retrospective on endojs/endo-but-for-bots PR #796 (primary: endojs-endo-but-for-bots-pr796-95d66baa)

role: prosecutor

A maintainer/contributor **attention** on #796 produced the primary job `endojs-endo-but-for-bots-pr796-95d66baa`
...
skills/review-retrospective/SKILL.md exactly:
  1. Idempotency: if review-misses/{misses,dismissed}/endojs-endo-but-for-bots-pr796-95d66baa.md exists, no-op.
...
Primary base: endojs-endo-but-for-bots-pr796-95d66baa
Primary directive identity: endojs/endo-but-for-bots#796:comment:5376416419
Retrospective identity: endojs/endo-but-for-bots#796:comment:5376416419:retro
Surface: pr-comment by kriskowal
Comment/Review: https://github.com/endojs/endo-but-for-bots/pull/796#issuecomment-5376416419
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-22T06:56:53Z
