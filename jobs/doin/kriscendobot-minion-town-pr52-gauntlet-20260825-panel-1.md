...
# Gauntlet stage: PANEL round 1 — kriscendobot/minion.town PR #52

You are ONE stage of a staged gauntlet (kriscendobot-minion-town-pr52-gauntlet-20260825). Run EXACTLY ONE panel round, post the
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh kriscendobot-minion-town-pr52-gauntlet-20260825-panel-1 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
3. Post the aggregate (in $GARDEN_PANEL_RUNDIR) as a `gh pr review` on https://github.com/kriscendobot/minion.town/pull/52 — the
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-25T14:47:19Z
