...
# Review directive on kriscendobot/garden PR #83

A trusted maintainer/contributor REVIEW on #83. Treat the WHOLE review
...
Review: https://github.com/kriscendobot/garden/pull/83#pullrequestreview-5119824896
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/garden/pulls/83/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/garden/pulls/83/reviews/REVIEW_ID --jq .body
...
[APPROVED] @kriscendobot Please reconcile this with the ongoing cybernetics design as a follow-up on that implementation. These are both in flight and may need to coordinate. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/garden 83 5119824896 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-05T04:50:37Z
