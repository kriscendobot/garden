...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T18:01:05Z cleared=none -->
...
---
handler-timeout: 7200
# Implement Intl numeric and list formatters
...
`test/intl402/{NumberFormat,PluralRules,RelativeTimeFormat,ListFormat,DisplayNames,DurationFormat}/**`.

Implementation scope:
Build on child 19 to implement constructor/options, format/formatToParts/range behavior and locale-data fallback for the numeric, plural, relative-time, list, display-name and duration families.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-14T18:01:09Z
