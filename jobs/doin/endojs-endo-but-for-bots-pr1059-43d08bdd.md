...
Comment: https://github.com/endojs/endo-but-for-bots/pull/1059#issuecomment-5473017451
...
Thanks — this was a sharp review. I verified every finding against the code before changing anything; eight of the nine blocking findings and all five additional issues were confirmed (one blocking finding was already fixed by the schema-v13 iterator carry that landed just befo

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1059 5473017451 kumavis
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-31T03:41:12Z
