...
# Gauntlet stage: PANEL round 2 — endojs/endo-but-for-bots PR #695

You are ONE stage of a staged gauntlet (endojs-endo-but-for-bots-pr695-gauntlet-23a03130-pinned). Run EXACTLY ONE panel round, post the
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh endojs-endo-but-for-bots-pr695-gauntlet-23a03130-pinned-panel-2 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
2. Run the panel in SINGLE-ROUND mode against that worktree:
   `GARDEN_PANEL_SINGLE_ROUND=1 \
     scripts/jobs/gardening/panel.sh <worktree> 695 <base-ref>`
...
3. Post the aggregate (in $GARDEN_PANEL_RUNDIR) as a `gh pr review` on https://github.com/endojs/endo-but-for-bots/pull/695 — the
...
<!-- garden-transient-elapsed: kind=exit0 through=0 values=129 -->
---
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-17T02:47:36Z
