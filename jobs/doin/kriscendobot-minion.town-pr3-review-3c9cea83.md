# Review directive on kriscendobot/minion.town PR #3

A trusted maintainer/contributor REVIEW on #3. Treat the WHOLE review
...
Review: https://github.com/kriscendobot/minion.town/pull/3#pullrequestreview-4667285220
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/minion.town/pulls/3/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/minion.town/pulls/3/reviews/REVIEW_ID --jq .body
...
A peer may have already resolved this feedback. Run, from the garden root:
  ...
  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/minion.town 3 4667285220 kriskowal
...
claim:
  ...
  gardener: 20
  claimed_at: 2026-07-09T23:06:47Z
