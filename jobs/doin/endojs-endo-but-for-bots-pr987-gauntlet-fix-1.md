...
# Gauntlet stage: FIX round 1 — endojs/endo-but-for-bots PR #987

You are ONE stage of a staged gauntlet (endojs-endo-but-for-bots-pr987-gauntlet). Apply the panel's must-fix items ONCE,
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh endojs-endo-but-for-bots-pr987-gauntlet-fix-1 endojs/endo-but-for-bots <pr-head-branch>`.
2. Read the LATEST panel verdict on https://github.com/endojs/endo-but-for-bots/pull/987 (the request-changes `gh pr review` the
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-14T21:50:13Z
