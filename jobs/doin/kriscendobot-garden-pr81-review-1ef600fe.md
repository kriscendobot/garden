...
# Review directive on kriscendobot/garden PR #81

A trusted maintainer/contributor REVIEW on #81. Treat the WHOLE review
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/garden/pulls/81/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/garden/pulls/81/reviews/REVIEW_ID --jq .body
...
[APPROVED] @kriscendobot Please conduct and wait for a deploy. Once deployed, please dispatch a test job to this lane to interactively validate that it can do work. Message the maintainer with a report regardless of outcome. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/garden 81 5119818493 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-05T04:48:41Z
