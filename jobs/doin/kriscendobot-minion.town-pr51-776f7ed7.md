...
dispatch: automatic
---
# attention directive on kriscendobot/minion.town PR #51

Map: **attention** → read the directive and route it to the right work.

Source: pr-comment by kriskowal
Comment: https://github.com/kriscendobot/minion.town/pull/51#issuecomment-5384220646
...
Let’s validate this on minion.town. Show me evidence that we can go, not from the tool call, but a sequence of git push and evaluation tool calls to publish and then update a weblets content and powers. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/minion.town 51 5384220646 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-23T04:32:58Z
