...
dispatch: automatic
---
# Issue from kriskowal on kriscendobot/garden #94
...
issue_spine: issue-kriscendobot-garden-94
issue_url: https://github.com/kriscendobot/garden/issues/94
submitter: kriskowal
----- END ISSUE NOTE -----

Re-fetch the issue verbatim:  gh issue view 94 -R kriscendobot/garden --comments
Reply when done:              gh issue comment https://github.com/kriscendobot/garden/issues/94 --body "…"

----- issue body excerpt (untrusted, truncated) -----
Please add the host name to the attribution footer on all engagements with github issues, comments, and pull request reviews and comments.  
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-16T00:27:07Z
