...
# Review directive on endojs/endo-but-for-bots PR #889

A trusted maintainer/contributor REVIEW on #889. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/889#pullrequestreview-5004042557
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/889/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/889/reviews/REVIEW_ID --jq .body
...
[CHANGES_REQUESTED] There are elements of this design that imply or require a coupling to a physical filesystem and worktree that is awkward to emulate on our virtual hierarchy. There is also a reflection of the branch name git ref, which is not intrinsic to a root except in the 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 889 5004042557 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-24T02:00:15Z
