...
pr: https://github.com/endojs/endo-but-for-bots/pull/356
tier: mentor
fallback-tier: minion
dispatch: automatic
---

# Gauntlet stage: PANEL round 1 — endojs/endo-but-for-bots PR #356

You are ONE stage of a staged gauntlet (endojs-endo-but-for-bots-pr356-gauntlet). Run EXACTLY ONE panel round, post the
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh endojs-endo-but-for-bots-pr356-gauntlet-panel-1 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
2. Run the panel in SINGLE-ROUND mode against that worktree:
   `GARDEN_PANEL_SINGLE_ROUND=1 \
     scripts/jobs/gardening/panel.sh <worktree> 356 <base-ref>`
...
3. Post the aggregate (in $GARDEN_PANEL_RUNDIR) as a `gh pr review` on https://github.com/endojs/endo-but-for-bots/pull/356 — the
...
<!-- garden-transient-elapsed: kind=signature through=1 values=4,25 -->
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-31T10:01:58Z
