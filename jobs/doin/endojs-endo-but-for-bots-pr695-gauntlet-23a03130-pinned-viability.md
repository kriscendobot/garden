...
# Gauntlet stage: PRE-SPEND VIABILITY - endojs/endo-but-for-bots PR #695

You are the viability gate for staged gauntlet (endojs-endo-but-for-bots-pr695-gauntlet-23a03130-pinned). Spend no clean, panel,
fix, CI-wait, or un-draft budget. Decide whether the gauntlet may begin, report the
evidence, then STOP.

1. Read current PR facts with
   `gh pr view https://github.com/endojs/endo-but-for-bots/pull/695 --json state,mergedAt,isDraft,title,body,baseRefName,headRefName,headRefOid,baseRefOid,url`.
