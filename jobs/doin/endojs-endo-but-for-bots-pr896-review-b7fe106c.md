...
# Review directive on endojs/endo-but-for-bots PR #896

A trusted maintainer/contributor REVIEW on #896. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/896#pullrequestreview-5057005098
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/896/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/896/reviews/REVIEW_ID --jq .body
...
[APPROVED] Post a follow up to check whether the framing protocols for syrup, cbor, and netstring are also factored to separate read from write 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 896 5057005098 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-29T05:31:45Z
