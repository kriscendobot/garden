# Botany: assess and dispose of endo-but-for-bots dependabot PR #270

Repo: `endojs/endo-but-for-bots` (a bot-owned fork; the bot holds merge authority).
PR: #270 (authored by `dependabot[bot]`).
...
This repo is bot-owned and this job authorizes, for PR #270 specifically:
...
- **close** — on a REJECT verdict, `gh pr close 270` with the verdict comment attached.
...
Run the botanist workflow end to end on PR #270:
...
claim:
  host: endolinbot
  gardener: 14
  claimed_at: 2026-06-24T10:33:37Z
