...
dispatch: automatic
---
# Review directive on kriscendobot/minion.town PR #18

A trusted maintainer/contributor REVIEW on #18. Treat the WHOLE review
...
Review: https://github.com/kriscendobot/minion.town/pull/18#pullrequestreview-4892002781
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/minion.town/pulls/18/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/minion.town/pulls/18/reviews/REVIEW_ID --jq .body
...
[APPROVED] For follow up: please not instructions for the maintainers to set up github secrets for deployment or execute them yourself. We should be able to remove the toy “minion” tools. We are not going to get much use of Oauth scopes so perhaps we should remove them.  

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/minion.town 18 4892002781 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-09T17:38:24Z
