...
# botanist (auto: dependabot PR, INCOMPATIBLE by preflight) on endojs/endo-but-for-bots PR #1274
...
Proof: `package.json` declares Node `^20.17.0 || >=22.9.0` (floor 20.17.0), but `electron` 44.2.0 requires Node
`>= 22.12.0`; the dependency excludes the project-supported floor.
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-13T20:10:04Z
