...
You are ONE stage of a staged gauntlet (kriscendobot-minion.town-pr41-gauntlet). Run EXACTLY ONE panel round, post the
verdict, then STOP — do NOT fix, do NOT un-draft, do NOT loop.

1. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh kriscendobot-minion.town-pr41-gauntlet-panel-1 kriscendobot/minion.town <pr-head-branch>`.
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-14T05:32:08Z
