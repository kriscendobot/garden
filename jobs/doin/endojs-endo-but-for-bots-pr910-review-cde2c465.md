...
# Review directive on endojs/endo-but-for-bots PR #910

A trusted maintainer/contributor REVIEW on #910. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/910#pullrequestreview-4941452327
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/910/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/910/reviews/REVIEW_ID --jq .body
...
[INLINE-REVIEW] [APPROVED] Please post a follow-up job to produce and exercise a disposable fuzzer on this new system and produce a follow-up build job to address any errors discovered. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 910 4941452327 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-14T21:59:16Z
