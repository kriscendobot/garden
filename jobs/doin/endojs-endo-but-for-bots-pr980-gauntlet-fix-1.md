...
You are ONE stage of a staged gauntlet (endojs-endo-but-for-bots-pr980-gauntlet). Apply the panel's must-fix items ONCE,
push, watch CI, then STOP — do NOT re-run the panel (the driver re-posts panel-2).

1. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh endojs-endo-but-for-bots-pr980-gauntlet-fix-1 endojs/endo-but-for-bots <pr-head-branch>`.
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-14T13:17:13Z
