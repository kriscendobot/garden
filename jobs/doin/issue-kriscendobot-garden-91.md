...
dispatch: automatic
---
# Issue from kumavis on kriscendobot/garden #91
...
Re-fetch the issue verbatim:  gh issue view 91 -R kriscendobot/garden --comments
Reply when done:              gh issue comment https://github.com/kriscendobot/garden/issues/91 --body "…"

----- issue body excerpt (untrusted, truncated) -----
IronHorse is undergoing a large external refactor. deprioritize all IronHorse work to zero until further notified 
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-09T14:09:00Z
