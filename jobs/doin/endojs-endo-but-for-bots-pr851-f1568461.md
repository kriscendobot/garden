...
dispatch: automatic
---
# attention directive on endojs/endo-but-for-bots PR #851

Map: **attention** → read the directive and route it to the right work.

Source: issue-comment by 0xpatrickdev
Comment: https://github.com/endojs/endo-but-for-bots/issues/851#issuecomment-5212022426
...
> 3. consider adding per-package lint:types (from clean state) to CI Agree, see endojs/endo-but-for-bots#922 Regarding 1 and 2, `E()` not playing nicely with types should be a thing of the past. `ERef<T>` / `FarRef<Primary>` from `@endo/eventual-send` give `E()` full type inferen

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 851 5212022426 0xpatrickdev
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-07T03:41:00Z
