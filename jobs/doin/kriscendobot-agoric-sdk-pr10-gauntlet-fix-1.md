...
# Gauntlet stage: FIX round 1 — kriscendobot/agoric-sdk PR #10

You are ONE stage of a staged gauntlet (kriscendobot-agoric-sdk-pr10-gauntlet). Apply the panel's must-fix items ONCE,
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh kriscendobot-agoric-sdk-pr10-gauntlet-fix-1 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
2. Read the LATEST panel verdict on https://github.com/kriscendobot/agoric-sdk/pull/10 (the request-changes `gh pr review` the
...
<!-- garden-transient-elapsed: kind=exit0 through=1 values=1187,67 -->
---
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-04T07:33:40Z
