...
# attention directive on endojs/endo-but-for-bots PR #1128

Map: **attention** → read the directive and route it to the right work.

Source: issue-comment by kriskowal
Comment: https://github.com/endojs/endo-but-for-bots/issues/1128#issuecomment-5535098862
...
@kriscendobot Please build a fix that omits the endo power from new and old guests 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1128 5535098862 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-04T03:09:57Z
