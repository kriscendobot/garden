...
dispatch: automatic
---
# Review directive on kriscendobot/list PR #1
...
Review: https://github.com/kriscendobot/list/pull/1#pullrequestreview-4901896157
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/list/pulls/1/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/list/pulls/1/reviews/REVIEW_ID --jq .body
...
A peer may have already resolved this feedback. Run, from the garden root:
  ...
  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/list 1 4901896157 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-10T23:57:45Z
