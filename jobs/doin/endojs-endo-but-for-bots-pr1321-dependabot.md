...
# botanist (auto: dependabot PR, INCOMPATIBLE by preflight) on endojs/endo-but-for-bots PR #1321
...
Package: `@babel/parser` 7.28.6 -> 8.0.5
Proof: `package.json` declares Node `^20.17.0 || >=22.9.0` (floor 20.17.0), but `@babel/parser` 8.0.5 requires Node
...
PR: https://github.com/endojs/endo-but-for-bots/pull/1321
