...
origin advanced to `6ff2f8caa4dc2fce8814c7077e86abedfa270b23` but the live tree is stuck at `93f2a623561f8cc7f7fe9a48b2e8be6d441ede90` — tracked working-tree changes block the fast-forward.
...
Blocking change(s):
```
 M scripts/jobs/handlers/proxy-claude.sh
```
...
claim:
  host: endolinbot
  gardener: 79
  claimed_at: 2026-06-27T18:28:30Z
