# Review directive on endojs/endo-but-for-bots PR #343

A trusted maintainer/contributor REVIEW on #343. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/343#pullrequestreview-4604609454
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/343/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/343/reviews/REVIEW_ID --jq .body
...
[APPROVED] Please conduct and post a job for the next phase. 

---
claim:
  host: endolinbot2
  gardener: 1
  claimed_at: 2026-06-30T22:58:06Z
