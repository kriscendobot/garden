...
# attention directive on kriscendobot/garden PR #108

Map: **attention** → read the directive and route it to the right work.

Source: pr-comment by kriskowal
Comment: https://github.com/kriscendobot/garden/pull/108#issuecomment-5798546568
...
@kriscendobot Please divide this into separate pull requests for the two topics. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/garden 108 5798546568 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-23T16:25:55Z
