...
# Review directive on endojs/endo-but-for-bots PR #152

A trusted maintainer/contributor REVIEW on #152. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/152#pullrequestreview-4931644775
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/152/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/152/reviews/REVIEW_ID --jq .body
...
[CHANGES_REQUESTED] Please adjust the merge base to a pinned llm-xxxxx hash branch and then refresh. Much has changed and this may have been obviated entirely. Please investigate. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 152 4931644775 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-13T21:14:19Z
