...
dispatch: automatic
---
# Review directive on endojs/endo-but-for-bots PR #945

A trusted maintainer/contributor REVIEW on #945. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/945#pullrequestreview-4876222433
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/945/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/945/reviews/REVIEW_ID --jq .body
...
A peer may have already resolved this feedback. Run, from the garden root:
  ...
  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 945 4876222433 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-06T15:23:59Z
