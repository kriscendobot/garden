...
2. **Regenerate the report in place**, keeping the existing structure and voice:
   ...
   Fully-qualify every ref as `owner/repo#N`. Stamp the snapshot **2026-07-13**.
...
4. **Commit + push to `journal2`** (`pr-review-sequence.md` at the journal root),
   message e.g. `pr-review-sequence: refresh snapshot 2026-07-13`. Journal-only — no
...
claim:
  ...
  gardener: 1
  claimed_at: 2026-07-13T23:01:30Z
