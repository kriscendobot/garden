...
role: designer
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-13T21:40:58Z cleared=none -->
...
dispatch: automatic
---
Read-only feature-disposition analysis for the staged model command family from https://github.com/endojs/endo-but-for-bots/pull/149.
...
Feature scope: Interactive list/show/set/test/commit/clear/help model configuration, staged validation, provider-key checks, commit semantics, and the incomplete persisted-clear and model-replacement behavior.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-13T21:41:24Z
