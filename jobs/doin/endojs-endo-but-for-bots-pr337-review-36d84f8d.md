...
# Review directive on endojs/endo-but-for-bots PR #337

A trusted maintainer/contributor REVIEW on #337. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/337#pullrequestreview-4943079221
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/337/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/337/reviews/REVIEW_ID --jq .body
...
[CHANGES_REQUESTED] Please adjust the merge base to llm-xxxxx and rebase. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 337 4943079221 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-15T06:33:37Z
