...
dispatch: automatic
---
# receipt (auto) — completion receipt for endojs/endo-but-for-bots PR #1304 (merged)
...
gh), and archives the receipt in the journal, all idempotently:
    ...
    scripts/jobs/pr-receipt.sh endojs/endo-but-for-bots 1304
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-18T21:07:53Z
