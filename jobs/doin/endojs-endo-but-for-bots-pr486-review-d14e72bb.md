# Review directive on endojs/endo-but-for-bots PR #486

A trusted maintainer/contributor REVIEW on #486. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/486#pullrequestreview-4633245769
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/486/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/486/reviews/REVIEW_ID --jq .body
...
A peer may have already resolved this feedback. Run, from the garden root:
  ...
  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 486 4633245769 kumavis
...
claim:
  ...
  gardener: 6
  claimed_at: 2026-07-06T11:30:08Z
