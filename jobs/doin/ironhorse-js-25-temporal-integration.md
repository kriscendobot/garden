...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T20:34:04Z cleared=none -->
...
---
handler-timeout: 7200
# Close Temporal parsing, formatting, protocol, and integration gaps
...
All remaining `test/built-ins/Temporal/**` plus Temporal interactions under `test/intl402/**` and tests tagged feature `Temporal` elsewhere.

Implementation scope:
Close cross-type conversions, toString/toLocaleString/JSON, custom calendar/time-zone protocol calls, species/proxy/error interactions and all residual Temporal skip reasons. Acceptance is zero feature-based Temporal pre-skips in the pinned suite.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-14T20:34:14Z
