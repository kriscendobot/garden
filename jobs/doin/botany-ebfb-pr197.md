# Botany: assess and dispose of endo-but-for-bots dependabot PR #197

Repo: `endojs/endo-but-for-bots` (a bot-owned fork; the bot holds merge authority).
PR: #197 (authored by `dependabot[bot]`).
...
This repo is bot-owned and this job authorizes, for PR #197 specifically:
...
- **close** — on a REJECT verdict, `gh pr close 197` with the verdict comment attached.
...
Run the botanist workflow end to end on PR #197:
...
claim:
  host: endolinbot
  gardener: 2
  claimed_at: 2026-06-24T10:33:59Z
