...
tier: mentor
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T22:43:24Z cleared=none -->
...
dispatch: automatic
---
# Close residual language gap: Object MOP on exotic/proxy objects (defineProperty / getOwnPropertyDescriptor / hasOwnProperty on non-object, index, and exotic receivers)

Part of the js-26 residual-closure orchestration (measured on PR endojs/endo-but-for-bots#970 head `b3c3ae93`). **This cluster: 1333 actionable cases** (unsupported + ironhorse-failure) as measured by the authoritative full-suite run at that head.

**Causal reason families in scope:**
- `unsupported-opcode` — 1333

**Top test262 subtrees:**
- `built-ins/Object` — 569
- `built-ins/Array` — 246
- `language/expressions` — 68
- `language/arguments-object` — 53
- `built-ins/Temporal` — 48
- `language/statements` — 46
- `annexB/built-ins` — 32
- `built-ins/Promise` — 22
- `intl402/NumberFormat` — 21
- `intl402/Locale` — 19
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-14T23:04:17Z
