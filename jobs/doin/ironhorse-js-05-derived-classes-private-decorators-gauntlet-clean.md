...
You are ONE stage of a staged gauntlet (ironhorse-js-05-derived-classes-private-decorators-gauntlet). Do ONLY the clean stage, then STOP.
...
2. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh ironhorse-js-05-derived-classes-private-decorators-gauntlet-clean endojs/endo-but-for-bots <pr-head-branch>`
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-08T11:02:12Z
