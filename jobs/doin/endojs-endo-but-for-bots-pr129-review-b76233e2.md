# Review directive on endojs/endo-but-for-bots PR #129

A trusted maintainer/contributor REVIEW on #129. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/129#pullrequestreview-4659780365
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/129/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/129/reviews/REVIEW_ID --jq .body
...
[APPROVED] Please rebase, run the gauntlet, retcon, and conduct. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 129 4659780365 kriskowal
...
claim:
  ...
  gardener: 14
  claimed_at: 2026-07-09T18:33:35Z
