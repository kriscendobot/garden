...
Comment: https://github.com/endojs/endo-but-for-bots/pull/1085#issuecomment-5536021610
...
@kriscendobot I am unsure whether the jury revealed this as well, but sorting the output of globStrem before continuing to grepStream would largely obviate the pipeline needlessly.  

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1085 5536021610 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-04T05:43:37Z
