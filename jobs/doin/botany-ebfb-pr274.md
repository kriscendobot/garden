# Botany: assess and dispose of endo-but-for-bots dependabot PR #274

Repo: `endojs/endo-but-for-bots` (a bot-owned fork; the bot holds merge authority).
PR: #274 (authored by `dependabot[bot]`).
...
This repo is bot-owned and this job authorizes, for PR #274 specifically:
...
- **close** — on a REJECT verdict, `gh pr close 274` with the verdict comment attached.
...
Run the botanist workflow end to end on PR #274:
...
claim:
  host: endolinbot
  gardener: 5
  claimed_at: 2026-06-24T10:33:24Z
