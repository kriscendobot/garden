...
dispatch: automatic
---
# Review directive on endojs/endo-but-for-bots PR #934

A trusted maintainer/contributor REVIEW on #934. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/934#discussion_r3729866951
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/934/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/934/reviews/REVIEW_ID --jq .body
...
Let's rely on a full sqlite close when suspending. Make sure that occurs. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 934 3729866951 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-06T14:55:24Z
