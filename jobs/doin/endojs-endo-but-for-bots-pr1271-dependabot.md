...
# botanist (auto: dependabot PR, INCOMPATIBLE by preflight) on endojs/endo-but-for-bots PR #1271
...
Package: `lerna` 8.2.4 -> 10.0.1
Proof: `package.json` declares Node `^20.17.0 || >=22.9.0` (floor 20.17.0), but `lerna` 10.0.1 requires Node
`^22.13.0 || ^24.0.0 || ^26.0.0`; the dependency excludes the project-supported floor.
...
PR: https://github.com/endojs/endo-but-for-bots/pull/1271
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-13T20:05:00Z
