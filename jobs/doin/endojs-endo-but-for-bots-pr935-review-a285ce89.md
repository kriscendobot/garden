...
# Review directive on endojs/endo-but-for-bots PR #935

A trusted maintainer/contributor REVIEW on #935. Treat the WHOLE review
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/935/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/935/reviews/REVIEW_ID --jq .body
...
@kriscendobot Please post a job to experimentally inject an `@reminders` capability into new guests on minion.town and validate this feature in production. Report here. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 935 5096445321 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-03T01:27:29Z
