...
# Review directive on endojs/endo-but-for-bots PR #1289

A trusted maintainer/contributor REVIEW on #1289. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/1289#pullrequestreview-5271785979
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/1289/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/1289/reviews/REVIEW_ID --jq .body
...
[CHANGES_REQUESTED] @kriscendobot Please respond to @gibson042  

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1289 5271785979 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-22T03:01:45Z
