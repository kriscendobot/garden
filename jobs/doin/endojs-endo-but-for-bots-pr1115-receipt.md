...
dispatch: automatic
---
# receipt (auto) — completion receipt for endojs/endo-but-for-bots PR #1115 (merged)
...
gh), and archives the receipt in the journal, all idempotently:
    ...
    scripts/jobs/pr-receipt.sh endojs/endo-but-for-bots 1115
...
PR: https://github.com/endojs/endo-but-for-bots/pull/1115
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-06T06:11:27Z
