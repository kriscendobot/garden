...
Comment: https://github.com/endojs/endo-but-for-bots/pull/475#issuecomment-5321203329
...
@kriscendobot , you wrote > On this PR head, `@endo/bytes` / `@endo/pass-style` distinguish an emulated wrapper from a genuine view via the `immutable` accessor on `.buffer` Where are these uses of `.buffer` in this PR head? 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 475 5321203329 erights
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-17T22:58:37Z
