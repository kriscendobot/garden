# Review directive on kriscendobot/agoric-sdk PR #10

A trusted maintainer/contributor REVIEW on #10. Treat the WHOLE review
...
Source: pr-review-body by michaelfig
Review: https://github.com/kriscendobot/agoric-sdk/pull/10#pullrequestreview-4765874818
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/agoric-sdk/pulls/10/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/agoric-sdk/pulls/10/reviews/REVIEW_ID --jq .body
...
LGTM!  @kriskowal, I'd like to allow other people to take a look at the design.  Can you provide guidance on how to open it to the public without implementing it yet?  

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/agoric-sdk 10 4765874818 michaelfig
...
claim:
  ...
  gardener: 16
  worker_kind: cleric
  claimed_at: 2026-07-23T15:56:34Z
