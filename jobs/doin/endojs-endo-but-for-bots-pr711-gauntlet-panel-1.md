...
3. Post the aggregate (in $GARDEN_PANEL_RUNDIR) as a `gh pr review` on https://github.com/endojs/endo-but-for-bots/pull/711 — the
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-31T22:44:15Z
