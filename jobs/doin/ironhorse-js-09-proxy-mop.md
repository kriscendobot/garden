...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-13T20:25:08Z cleared=none -->
...
---
handler-timeout: 7200
# Implement Proxy completely over the object MOP
...
All 311 official cases under `test/built-ins/Proxy/**`, plus every test elsewhere tagged with feature `Proxy`.

Implementation scope:
Implement the Proxy constructor and `Proxy.revocable`, a GC/snapshot-safe proxy side table, callable and constructable proxy exotics, all 13 traps (`apply`, `construct`, `defineProperty`, `deleteProperty`, `get`, `getOwnPropertyDescriptor`, `getPrototypeOf`, `has`, `isExtensible`, `ownKeys`, `preventExtensions`, `set`, `setPrototypeOf`), revocation, trap lookup/call, invariant enforcement, nested/exotic targets, realms, and metering. Route Object/Reflect/ordinary syntax through the shared behavior seam so traps cannot be bypassed. Starting evidence is 0 covered, 307 unsupported, 4 intentionally pre-skipped; acceptance is all applicable cases covered.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-13T20:25:12Z
