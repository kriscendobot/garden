...
split_orchestration: endojs-endo-but-for-bots-pr1301-review-3220af4b-split
reposted_by: reaper:endolin-garden-ece02cb4
reposted_at: 2026-09-20T09:23:05Z
---

# Deliberate overrun decomposition for `endojs-endo-but-for-bots-pr1301-review-3220af4b`
...
- **Divisible:** create at least two self-contained child jobs, park every child with `post-plan.sh --orchestrated --orchestrated-by endojs-endo-but-for-bots-pr1301-review-3220af4b-split`, then record `endojs-endo-but-for-bots-pr1301-review-3220af4b-split` with `post-orchestration.sh`.
- **Indivisible:** record a concrete `split-indivisible-reason:` in both the child body and orchestration description, choose a `handler-timeout:` strictly greater than 7200 and no greater than 14339, record that value as `split-indivisible-handler-timeout:` in the orchestration description, park exactly one child (normally `endojs-endo-but-for-bots-pr1301-review-3220af4b-expanded-window`) under `endojs-endo-but-for-bots-pr1301-review-3220af4b-split`, then record the single-child orchestration. A generic "too large" assertion is not a reason.
- In either case, finish only after the parked child set and orchestration record exist durably. Declare the exact handoff `<<<GARDEN-JOB-HANDED-OFF: endojs-endo-but-for-bots-pr1301-review-3220af4b-split>>>` immediately before the completion signal so completion verifies the successor.
...
Review: https://github.com/endojs/endo-but-for-bots/pull/1301#pullrequestreview-5259855118
...
A peer may have already resolved this feedback. Run, from the garden root:
  ...
  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1301 5259855118 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-20T09:23:12Z
