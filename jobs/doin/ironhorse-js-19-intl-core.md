...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T17:34:03Z cleared=none -->
...
---
handler-timeout: 7200
# Implement Intl core, Locale, Collator, and canonicalization
...
`test/intl402/Intl/**`, `test/intl402/Locale/**`, and `test/intl402/Collator/**`.

Implementation scope:
Add a deterministic locale-data strategy and implement canonicalization, option extraction, supportedLocalesOf, Locale fields/maximize/minimize and Collator compare. Pin data/version provenance so snapshots and metering are reproducible across hosts.
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-14T17:34:22Z
