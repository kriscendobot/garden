...
dispatch: automatic
---
# Close residual language gap: async: run-skips, Array.fromAsync async iteration, and async-generator/await residue

Part of the js-26 residual-closure orchestration (measured on PR endojs/endo-but-for-bots#970 head `b3c3ae93`). **This cluster: 500 actionable cases** (unsupported + ironhorse-failure) as measured by the authoritative full-suite run at that head.

**Causal reason families in scope:**
- `async` — 419
- `unsupported-opcode` — 81

**Top test262 subtrees:**
- `language/statements` — 158
- `language/expressions` — 130
- `built-ins/Promise` — 108
- `built-ins/Array` — 81
- `built-ins/AsyncFromSyncIteratorPrototype` — 16
- `built-ins/AsyncGeneratorPrototype` — 5
- `built-ins/AsyncDisposableStack` — 1
- `built-ins/AsyncFunction` — 1
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-15T01:34:20Z
