...
# Finalize (curate -> merge) kriscendobot/oros-ckm-data-readiness PR #1
...
Guards (the reconciler already enforced these; re-verify before merging):
  - Bot repo only (kriscendobot/oros-ckm-data-readiness). NEVER merge agoric-sdk or the endojs/endo
