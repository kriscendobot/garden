...
dispatch: automatic
---
# attention directive on endojs/endo-but-for-bots PR #1107

Map: **attention** → read the directive and route it to the right work.

Source: pr-comment by kumavis
Comment: https://github.com/endojs/endo-but-for-bots/pull/1107#issuecomment-5494282148
...
CI on `aa8eb640c` is red on **test (22.x, ubuntu-latest)** only, and the evidence says flake, not this diff: - All 1217 tests passed; the job fails solely on `Unhandled rejection in test/endo.test.js: Error: Termination requested` (empty stack) at teardown — a worker torn down 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1107 5494282148 kumavis
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-01T12:58:21Z
