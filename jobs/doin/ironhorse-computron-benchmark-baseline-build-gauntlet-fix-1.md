...
# Gauntlet stage: FIX round 1 — endojs/endo-but-for-bots PR #1283
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh ironhorse-computron-benchmark-baseline-build-gauntlet-fix-1 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
<!-- garden-transient-elapsed: kind=exit0 through=0 values=1138 -->
---
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-16T05:54:08Z
