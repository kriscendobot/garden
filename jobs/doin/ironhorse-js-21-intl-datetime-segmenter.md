...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T18:46:06Z cleared=none -->
...
---
handler-timeout: 7200
# Implement Intl DateTimeFormat and Segmenter
...
`test/intl402/{DateTimeFormat,Segmenter}/**`.

Implementation scope:
Implement time-zone/calendar formatting, ranges and parts plus locale-sensitive grapheme/word/sentence segmentation. Pin tzdb/Unicode data and keep results reproducible against the oracle.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-14T18:46:11Z
