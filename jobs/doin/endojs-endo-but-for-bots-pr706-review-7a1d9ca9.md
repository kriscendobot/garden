# Review directive on endojs/endo-but-for-bots PR #706

A trusted maintainer/contributor REVIEW on #706. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/706#pullrequestreview-4690544829
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/706/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/706/reviews/REVIEW_ID --jq .body
...
A peer may have already resolved this feedback. Run, from the garden root:
  ...
  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 706 4690544829 0xpatrickdev
...
claim:
  ...
  claimed_at: 2026-07-14T07:23:15Z
