...
You are ONE stage of a staged gauntlet (ebfb-exo-stream-drop-base64-stream-methods-gauntlet). Do ONLY the clean stage, then STOP.
...
2. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh ebfb-exo-stream-drop-base64-stream-methods-gauntlet-clean <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-31T22:17:57Z
