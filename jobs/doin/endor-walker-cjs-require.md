...
dispatch: automatic
---
# Build Increment 1 — CommonJS require() graph-following (Group A)
...
Teach the walker to follow `require()` edges. Graduate cjs-compat, cycle-cjs,
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-19T06:43:34Z
