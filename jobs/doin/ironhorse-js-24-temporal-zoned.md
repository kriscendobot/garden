...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T19:58:04Z cleared=none -->
...
---
handler-timeout: 7200
# Implement Temporal ZonedDateTime, time zones, and Now
...
`test/built-ins/Temporal/{ZonedDateTime,TimeZone,Now}/**`.

Implementation scope:
Implement offset/time-zone parsing, transition/disambiguation behavior, zoned arithmetic/difference/rounding, startOfDay/hoursInDay and deterministic Now host hooks. Reuse the pinned tzdb strategy from Intl DateTimeFormat.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-14T19:58:08Z
