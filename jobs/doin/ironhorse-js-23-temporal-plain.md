...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T19:43:04Z cleared=none -->
...
---
handler-timeout: 7200
# Implement Temporal plain date and time families
...
`test/built-ins/Temporal/{PlainDate,PlainTime,PlainDateTime,PlainMonthDay,PlainYearMonth,Calendar}/**`.

Implementation scope:
Build on Temporal core for ISO calendar math, fields/from/with, arithmetic/difference/rounding, conversions and calendar protocol behavior across the plain families.
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-14T19:43:08Z
