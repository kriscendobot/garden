...
1. It is a child named in `jobs/orch/claude-on-minion-town-designs.md`, or a child of any
   later orchestration that record or the arc issue spawned. The seven original design
...
3. Its body references arc issue 89, or the arc's tracked artifacts:
   ...
   `endo-gateway-mcp.md`, and the six new designs the arc commissions).
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-08T19:06:30Z
