# Review directive on endojs/endo-but-for-bots PR #528

A trusted maintainer/contributor REVIEW on #528. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/528#pullrequestreview-4574139518
...
trailing number in the Review URL above), each with its file:line + text:
  gh api repos/endojs/endo-but-for-bots/pulls/528/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/528/reviews/REVIEW_ID --jq .body
...
claim:
  host: endolinbot
  gardener: 52
  claimed_at: 2026-06-25T19:05:06Z
