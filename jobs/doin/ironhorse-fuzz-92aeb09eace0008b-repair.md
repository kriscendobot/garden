...
# Fix Ironhorse fuzz finding 92aeb09eace0008b (target `differential_regexp`) and amend the standing PR
...
- Minimized input sha256: `663a47b2beee4e5278fc608d427be4d132251f0863a5a8af73cbeed45321adb2` (3 bytes)
- Durable artifact (leader host): `/home/kris/garden2/.garden-state/ironhorse-fuzz/findings/92aeb09eace0008b/input.bin`
- Portable copy: `input_base64` in journal `ironhorse-fuzz/findings/92aeb09eace0008b.md`
...
2. Recover the minimized input to a FILE without inlining it into any prompt:
   ...
   durable artifact path above. Verify `sha256sum` equals `663a47b2beee4e5278fc608d427be4d132251f0863a5a8af73cbeed45321adb2`.
...
7. Document THIS case and its solution in the standing PR body or a PR comment (finding 92aeb09eace0008b).
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-31T03:22:35Z
