...
# Review directive on kriscendobot/garden PR #109

A trusted maintainer/contributor REVIEW on #109. Treat the WHOLE review
...
Review: https://github.com/kriscendobot/garden/pull/109#pullrequestreview-5293869021
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/garden/pulls/109/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/garden/pulls/109/reviews/REVIEW_ID --jq .body
...
[INLINE-REVIEW] [APPROVED] @kriscendobot Please consolidate my feedback and proceed to implementation. Report here when a pilot is ready to run. That is, it must be deployed such that a liaison can pick up the muster. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/garden 109 5293869021 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-23T17:35:51Z
