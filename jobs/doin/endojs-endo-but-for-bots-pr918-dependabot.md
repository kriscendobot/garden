...
dispatch: automatic
---
# botanist (auto: dependabot PR) on endojs/endo-but-for-bots PR #918
...
Watcher preflight: parsed as a bump of `@babel/types` 7.29.0 -> 8.0.4, and NO other open
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-05T15:37:23Z
