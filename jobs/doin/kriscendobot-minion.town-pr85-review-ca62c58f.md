...
# Review directive on kriscendobot/minion.town PR #85

A trusted maintainer/contributor REVIEW on #85. Treat the WHOLE review
...
Review: https://github.com/kriscendobot/minion.town/pull/85#pullrequestreview-5109090330
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/minion.town/pulls/85/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/minion.town/pulls/85/reviews/REVIEW_ID --jq .body
...
[CHANGES_REQUESTED] @kriscendobot It occurs to me that the more worthy first experiment would look like this: - A clip has a unique URL and immutable content - All static content is cached forever. We reserve the option of mounting dynamic content routes, but not at this time. - 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/minion.town 85 5109090330 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-04T04:10:12Z
