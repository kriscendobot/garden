...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T16:49:03Z cleared=none -->
...
---
handler-timeout: 7200
# Complete explicit resource management
...
`test/language/statements/{using,await-using}/**` and `test/built-ins/{DisposableStack,AsyncDisposableStack,SuppressedError}/**`.

Implementation scope:
Build on parser, error, Promise and async-iteration prerequisites to implement disposal scopes, Symbol.dispose/Symbol.asyncDispose, LIFO cleanup, move/use/adopt/defer, SuppressedError chaining and abrupt-completion ordering. Reconfirm the three former non-termination cases terminate with correct negative verdicts.
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-14T16:49:08Z
