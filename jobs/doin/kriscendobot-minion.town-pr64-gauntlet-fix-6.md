...
# Gauntlet stage: FIX round 6 — kriscendobot/minion.town PR #64
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh kriscendobot-minion.town-pr64-gauntlet-fix-6 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-29T13:35:19Z
