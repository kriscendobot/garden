# Review directive on endojs/endo-but-for-bots PR #548

A trusted maintainer/contributor REVIEW on #548. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/548#pullrequestreview-4597029908
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/548/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/548/reviews/REVIEW_ID --jq .body
...
claim:
  host: endolinbot2
  gardener: 96
  claimed_at: 2026-06-30T03:38:22Z
