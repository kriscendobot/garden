...
# Gauntlet stage: PRE-SPEND VIABILITY - endojs/endo-but-for-bots PR #1301

You are the viability gate for staged gauntlet (endojs-endo-but-for-bots-pr1301-gauntlet-20260918). Spend no clean, panel,
fix, CI-wait, or un-draft budget. Decide whether the gauntlet may begin, report the
evidence, then STOP.

1. Read current PR facts with
   `gh pr view https://github.com/endojs/endo-but-for-bots/pull/1301 --json state,mergedAt,isDraft,title,body,baseRefName,headRefName,headRefOid,baseRefOid,url`.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-18T22:24:57Z
