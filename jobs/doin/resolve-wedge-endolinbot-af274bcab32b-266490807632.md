...
origin advanced to `af274bcab32b49c0127e078075ddf23ff21f5f86` but the live tree is stuck at `6ff2f8caa4dc2fce8814c7077e86abedfa270b23` — tracked working-tree changes block the fast-forward.
...
Blocking change(s):
```
 M scripts/jobs/test/run-test.sh
```
...
claim:
  host: endolinbot
  gardener: 19
  claimed_at: 2026-06-27T18:44:56Z
