...
dispatch: automatic
---
# attention directive on endojs/endo-but-for-bots PR #1062

Map: **attention** → read the directive and route it to the right work.

Source: issue-comment by gibson042
Comment: https://github.com/endojs/endo-but-for-bots/issues/1062#issuecomment-5427621486
...
https://tc39.es/ecma262/multipage/ordinary-and-exotic-objects-behaviours.html#sec-typedarray-preventextensions has required the above code to throw an error since https://github.com/tc39/ecma262/pull/3453 . Current V8 conforms with that requirement, and it looks to me like Node.j

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1062 5427621486 gibson042
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-26T15:45:16Z
