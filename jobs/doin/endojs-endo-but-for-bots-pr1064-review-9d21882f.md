...
# Review directive on endojs/endo-but-for-bots PR #1064

A trusted maintainer/contributor REVIEW on #1064. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/1064#pullrequestreview-5045929318
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/1064/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/1064/reviews/REVIEW_ID --jq .body
...
[APPROVED] Please post a follow-up job to propose a change that causes these tests to be run in every environment, removing the lockdownOnly flag from the run. This may reveal new failures that need addressing, but moreover will increase clarity for coverage ratchets. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1064 5045929318 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-27T21:45:01Z
