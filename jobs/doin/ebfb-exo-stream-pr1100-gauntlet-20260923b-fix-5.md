...
# Gauntlet stage: FIX round 5 — endojs/endo-but-for-bots PR #1100

You are ONE stage of a staged gauntlet (ebfb-exo-stream-pr1100-gauntlet-20260923b). Apply the panel's must-fix items ONCE,
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh ebfb-exo-stream-pr1100-gauntlet-20260923b-fix-5 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-24T04:17:13Z
