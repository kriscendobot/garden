...
# Review directive on kriscendobot/garden PR #74

A trusted maintainer/contributor REVIEW on #74. Treat the WHOLE review
...
Review: https://github.com/kriscendobot/garden/pull/74#pullrequestreview-4977234911
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/garden/pulls/74/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/garden/pulls/74/reviews/REVIEW_ID --jq .body
...
[CHANGES_REQUESTED] Let’s drop this design outright. We don’t want to contribute to contributor tier and would otherwise be attracted to the price only. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/garden 74 4977234911 kriskowal
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-19T22:18:28Z
