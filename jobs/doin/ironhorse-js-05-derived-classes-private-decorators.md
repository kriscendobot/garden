...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=high at=2026-08-08T09:22:03Z cleared=none -->
...
---
handler-timeout: 7200
# Complete derived classes, super, private elements, and decorators
...
Remaining `test/language/{expressions,statements}/class/**`, `test/language/expressions/super/**`, private-field/private-method cases under `test/language/**`, and feature `decorators` cases.

Implementation scope:
Build on child 04 for derived construction, `super()`/super property references, field ordering, static blocks, private brands/elements, class heritage edge cases, and the authoritative decorators semantics present in the pinned corpus. Do not broaden the ordinary MOP ad hoc; use its behavior seam.
