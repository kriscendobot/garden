...
# Fix Ironhorse fuzz finding 5c29667cc15d6d93 (target `differential_source`) and amend the standing PR
...
- Minimized input sha256: `203db557fe4893accc7f29b36e0fc723551a7494f0c33a65e809ec88045449e2` (5 bytes)
- Durable artifact (leader host): `/home/kris/garden2/.garden-state/ironhorse-fuzz/findings/5c29667cc15d6d93/input.bin`
- Portable copy: `input_base64` in journal `ironhorse-fuzz/findings/5c29667cc15d6d93.md`
...
2. Recover the minimized input to a FILE without inlining it into any prompt:
   ...
   durable artifact path above. Verify `sha256sum` equals `203db557fe4893accc7f29b36e0fc723551a7494f0c33a65e809ec88045449e2`.
...
7. Document THIS case and its solution in the standing PR body or a PR comment (finding 5c29667cc15d6d93).
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-30T06:08:40Z
