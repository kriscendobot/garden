...
You are ONE stage of a staged gauntlet (ebfb-ascii-adopt-ocapn-sites-gauntlet). Do ONLY the clean stage, then STOP.
...
2. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh ebfb-ascii-adopt-ocapn-sites-gauntlet-clean endojs/endo-but-for-bots <pr-head-branch>`
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-13T21:51:01Z
