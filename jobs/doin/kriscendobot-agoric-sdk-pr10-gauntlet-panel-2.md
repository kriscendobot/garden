...
# Gauntlet stage: PANEL round 2 — kriscendobot/agoric-sdk PR #10
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh kriscendobot-agoric-sdk-pr10-gauntlet-panel-2 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
<!-- garden-transient-elapsed: kind=signature through=1 values=98 -->
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-04T09:33:08Z
