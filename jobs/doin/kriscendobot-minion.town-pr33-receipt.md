...
dispatch: automatic
---
# receipt (auto) — completion receipt for kriscendobot/minion.town PR #33 (closed)
...
gh), and archives the receipt in the journal, all idempotently:
    ...
    scripts/jobs/pr-receipt.sh kriscendobot/minion.town 33
...
PR: https://github.com/kriscendobot/minion.town/pull/33
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-11T22:55:22Z
