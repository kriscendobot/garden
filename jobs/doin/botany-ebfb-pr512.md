# Botany: assess and dispose of endo-but-for-bots dependabot PR #512

Repo: `endojs/endo-but-for-bots` (a bot-owned fork; the bot holds merge authority).
PR: #512 (authored by `dependabot[bot]`).
...
This repo is bot-owned and this job authorizes, for PR #512 specifically:
...
- **close** — on a REJECT verdict, `gh pr close 512` with the verdict comment attached.
...
Run the botanist workflow end to end on PR #512:
...
claim:
  host: endolinbot
  gardener: 70
  claimed_at: 2026-06-24T10:30:30Z
