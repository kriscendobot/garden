...
# Review directive on endojs/endo-but-for-bots PR #1040

A trusted maintainer/contributor REVIEW on #1040. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/1040#pullrequestreview-4986303659
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/1040/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/1040/reviews/REVIEW_ID --jq .body
...
[CHANGES_REQUESTED] I’m expecting this harness to be able to generate lists of which tests were skipped, failed, passed indexed by the scenario. Is that work in a follow-up PR upstream, or is the necessary machinery here and we just need to enable it? The objective is for subse

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1040 4986303659 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-20T18:54:28Z
