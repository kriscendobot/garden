# Review directive on endojs/endo-but-for-bots PR #509

A trusted maintainer/contributor REVIEW on #509. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/509#pullrequestreview-4574542456
...
trailing number in the Review URL above), each with its file:line + text:
  gh api repos/endojs/endo-but-for-bots/pulls/509/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/509/reviews/REVIEW_ID --jq .body
...
claim:
  host: endolinbot
  gardener: 60
  claimed_at: 2026-06-25T20:10:11Z
