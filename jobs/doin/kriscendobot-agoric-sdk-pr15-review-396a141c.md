...
Review: https://github.com/kriscendobot/agoric-sdk/pull/15#pullrequestreview-4725911405
...
[INLINE-REVIEW] [CHANGES_REQUESTED] `M.any()` should be used only in exceptional circumstances; it should have explicit justification. Use appropriate shapes such as `TargetAllocationShape` 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/agoric-sdk 15 4725911405 dckc
...
claim:
  ...
  claimed_at: 2026-07-17T20:46:36Z
