...
You are ONE stage of a staged gauntlet (finbot-progress-20260729-195004-gauntlet). Run EXACTLY ONE panel round, post the
verdict, then STOP — do NOT fix, do NOT un-draft, do NOT loop.

1. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh finbot-progress-20260729-195004-gauntlet-panel-1 kriscendobot/finbot <pr-head-branch>`.
...
claim:
  ...
  gardener: 1
  worker_kind: cleric
  claimed_at: 2026-07-29T19:59:28Z
