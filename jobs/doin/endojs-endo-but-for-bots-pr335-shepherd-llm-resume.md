# shepherd on endojs/endo-but-for-bots PR #335 (llm lint-ceiling resume)

Repo: endojs/endo-but-for-bots (bot-pushable; bot-repo only, no upstream endojs/endo touch).

PR #335 (base per its head) was blocked by the typescript-eslint project-service lint scaling
...
Task: rebase PR #335 onto current `origin/llm` and drive CI to green. Its base is live `llm`.
...
claim:
  host: endolinbot2
  gardener: 34
  claimed_at: 2026-07-02T10:04:17Z
