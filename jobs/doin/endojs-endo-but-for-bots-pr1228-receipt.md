...
dispatch: automatic
---
# receipt (auto) — completion receipt for endojs/endo-but-for-bots PR #1228 (closed)
...
gh), and archives the receipt in the journal, all idempotently:
    ...
    scripts/jobs/pr-receipt.sh endojs/endo-but-for-bots 1228
...
<!-- garden-transient-elapsed: kind=exit0 through=0 values=480 -->
<!-- garden-reap-now -->
---
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-22T01:56:10Z
