...
dispatch: automatic
---
# Shepherd endojs/endo-but-for-bots #1074 — regenerate Ironhorse hardened262 baselines, drive CI green

PR #1074 (TypedArray intrinsic-metadata hardened262 coverage) is OPEN, un-drafted,
and stalled RED on the gating `test-xs` check. Its conductor
(`endojs-endo-but-for-bots-pr1074-conduct`, in `jobs/tada/`) diagnosed the cause
...
> result baseline. This PR's new hardened262 `TypedArray` intrinsic-metadata test file
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-28T15:09:48Z
