...
tier: mentor
---
<!-- garden-promoted-from-plan: gate=deferred priority=low at=2026-08-22T05:52:19Z cleared=none -->
...
dispatch: automatic
---
# Retrospective on endojs/endo-but-for-bots PR #475 (primary: endojs-endo-but-for-bots-pr475-fa8acb7f)

role: prosecutor

A maintainer/contributor **attention** on #475 produced the primary job `endojs-endo-but-for-bots-pr475-fa8acb7f`
...
skills/review-retrospective/SKILL.md exactly:
  1. Idempotency: if review-misses/{misses,dismissed}/endojs-endo-but-for-bots-pr475-fa8acb7f.md exists, no-op.
...
Primary base: endojs-endo-but-for-bots-pr475-fa8acb7f
Primary directive identity: endojs/endo-but-for-bots#475:comment:5321778831
Retrospective identity: endojs/endo-but-for-bots#475:comment:5321778831:retro
Surface: pr-comment by erights
Comment/Review: https://github.com/endojs/endo-but-for-bots/pull/475#issuecomment-5321778831
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-22T06:16:03Z
