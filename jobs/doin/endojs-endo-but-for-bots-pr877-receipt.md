...
dispatch: automatic
---
# receipt (auto) — completion receipt for endojs/endo-but-for-bots PR #877 (merged)
...
gh), and archives the receipt in the journal, all idempotently:
    ...
    scripts/jobs/pr-receipt.sh endojs/endo-but-for-bots 877
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-14T14:39:54Z
