...
dispatch: automatic
---
# attention directive on kriscendobot/minion.town PR #56

Map: **attention** → read the directive and route it to the right work.

Source: pr-comment by kriskowal
Comment: https://github.com/kriscendobot/minion.town/pull/56#issuecomment-5501487759
...
@kriscendobot rsvp > The invitation acceptance flow needs to take into account that an invitation does not immediately provision a new guest, and that the recipient of the invitation may already have a guest assigned. So, there is a fork in the workflow, where the recipient of th

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/minion.town 56 5501487759 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-01T22:52:45Z
