...
dispatch: automatic
---
# receipt (auto) — completion receipt for endojs/endo-but-for-bots PR #1113 (merged)
...
gh), and archives the receipt in the journal, all idempotently:
    ...
    scripts/jobs/pr-receipt.sh endojs/endo-but-for-bots 1113
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-07T08:03:39Z
