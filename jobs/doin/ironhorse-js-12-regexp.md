...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T14:43:05Z cleared=none -->
...
---
handler-timeout: 7200
# Complete RegExp syntax, Unicode semantics, and protocol methods
...
`test/built-ins/RegExp/**`, `test/language/literals/regexp/**`, and the RegExp annex-B slice.

Implementation scope:
Close property escapes, u/v Unicode sets, inline modifiers, named captures/backreferences, syntax-error construction, flags, indices, exec state, species and Symbol match/matchAll/replace/search/split integration. Keep the compiler and `ironhorse-regexp` identifier tables in sync.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-14T14:43:12Z
