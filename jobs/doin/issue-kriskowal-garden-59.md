# Issue from dckc on kriskowal/garden #59
...
Re-fetch the issue verbatim:  gh issue view 59 -R kriskowal/garden --comments
Reply when done:              gh issue comment https://github.com/kriskowal/garden/issues/59 --body "…"
