# Review directive on endojs/endo-but-for-bots PR #661

A trusted maintainer/contributor REVIEW on #661. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/661#pullrequestreview-4701071242
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/661/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/661/reviews/REVIEW_ID --jq .body
...
[APPROVED] Please post a follow-up job to design an HTTP controller UI in Chat, such that the show value modal for an HTTP controller is a control surface for the HTTP client. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 661 4701071242 kriskowal
...
claim:
  ...
  gardener: 10
  worker_kind: cleric
  claimed_at: 2026-07-15T05:18:03Z
