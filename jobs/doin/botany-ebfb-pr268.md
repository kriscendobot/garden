# Botany: assess and dispose of endo-but-for-bots dependabot PR #268

Repo: `endojs/endo-but-for-bots` (a bot-owned fork; the bot holds merge authority).
PR: #268 (authored by `dependabot[bot]`).
...
This repo is bot-owned and this job authorizes, for PR #268 specifically:
...
- **close** — on a REJECT verdict, `gh pr close 268` with the verdict comment attached.
...
Run the botanist workflow end to end on PR #268:
...
claim:
  host: endolinbot
  gardener: 76
  claimed_at: 2026-06-24T10:33:47Z
