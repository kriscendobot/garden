# Review directive on endojs/endo-but-for-bots PR #678

A trusted maintainer/contributor REVIEW on #678. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/678#pullrequestreview-4680247381
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/678/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/678/reviews/REVIEW_ID --jq .body
...
A peer may have already resolved this feedback. Run, from the garden root:
  ...
  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 678 4680247381 kriskowal
...
claim:
  ...
  gardener: 20
  claimed_at: 2026-07-12T14:58:25Z
