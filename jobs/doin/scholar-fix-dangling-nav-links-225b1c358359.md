...
`b2865a3b6`. These are scholar-authored navigation surfaces (concepts/topics/sources/
...
```
  sources/tc39-module-harmony--compartments-compartment-class.md -> ../sections/tc39-module-harmony--compartments-compartment-import-evaluate-methods.md
  sources/tc39-module-harmony--compartments-compartment-class.md -> ../sections/tc39-module-harmony--compartments-compartment-resolve-load-hooks.md
  sources/tc39-module-harmony--compartments-compartment-class.md -> ../sections/tc39-module-harmony--compartments-compartment-thenable-hazard.md
```
...
claim:
  ...
  claimed_at: 2026-07-21T19:22:41Z
