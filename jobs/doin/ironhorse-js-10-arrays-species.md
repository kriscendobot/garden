...
---
handler-timeout: 7200
# Complete Array construction and prototype algorithms
...
`test/built-ins/Array/**`, `test/built-ins/ArrayIteratorPrototype/**`, and array literal/destructuring/spread cases in `test/language/expressions/**`.

Implementation scope:
Close the 2,330 unsupported Array.prototype cases and related constructor/from/of/species/iterator holes. Cover sparse and array-like objects, accessors and proxies through the MOP, general iterables, length invariants, stable sort semantics, copying methods, callbacks and data-dependent metering.
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-13T21:25:11Z
