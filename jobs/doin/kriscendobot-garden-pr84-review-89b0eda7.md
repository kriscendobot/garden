...
# Review directive on kriscendobot/garden PR #84

A trusted maintainer/contributor REVIEW on #84. Treat the WHOLE review
...
Review: https://github.com/kriscendobot/garden/pull/84#pullrequestreview-5119827342
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/garden/pulls/84/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/garden/pulls/84/reviews/REVIEW_ID --jq .body
...
[INLINE-REVIEW] [APPROVED] @kriscendobot Please address feedback and conduct, then dispatch a builder to implement. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/garden 84 5119827342 kriskowal
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-05T04:52:08Z
