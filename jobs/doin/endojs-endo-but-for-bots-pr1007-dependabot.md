...
# botanist (auto: dependabot PR) on endojs/endo-but-for-bots PR #1007
...
Watcher preflight: parsed as a bump of `@octokit/core` 3.6.0 -> 7.0.7, and NO other open
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-16T20:43:26Z
