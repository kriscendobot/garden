...
# Gauntlet stage: PANEL round 2 — endojs/endo-but-for-bots PR #1085

You are ONE stage of a staged gauntlet (endojs-endo-but-for-bots-pr1085-streamgrep-incremental-walk-gauntlet). Run EXACTLY ONE panel round, post the
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh endojs-endo-but-for-bots-pr1085-streamgrep-incremental-walk-gauntlet-panel-2 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
<!-- garden-transient-elapsed: kind=exit0 through=1 values=668,74 -->
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-09-04T14:56:39Z
