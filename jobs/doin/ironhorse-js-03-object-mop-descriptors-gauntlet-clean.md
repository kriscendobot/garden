...
You are ONE stage of a staged gauntlet (ironhorse-js-03-object-mop-descriptors-gauntlet). Do ONLY the clean stage, then STOP.
...
2. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh ironhorse-js-03-object-mop-descriptors-gauntlet-clean endojs/endo-but-for-bots <pr-head-branch>`
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-08T08:50:13Z
