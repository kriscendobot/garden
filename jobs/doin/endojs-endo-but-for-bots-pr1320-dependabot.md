...
# botanist (auto: dependabot PR, INCOMPATIBLE by preflight) on endojs/endo-but-for-bots PR #1320
...
Proof: `package.json` declares Node `^20.17.0 || >=22.9.0` (floor 20.17.0), but `execa` 10.0.1 requires Node
...
PR: https://github.com/endojs/endo-but-for-bots/pull/1320
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-20T20:08:52Z
