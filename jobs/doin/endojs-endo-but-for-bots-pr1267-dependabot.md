...
# botanist (auto: dependabot PR) on endojs/endo-but-for-bots PR #1267
...
Watcher preflight: parsed as a bump of `actions/deploy-pages` 5.0.0 -> 5.0.1, and NO other open
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-13T19:53:51Z
