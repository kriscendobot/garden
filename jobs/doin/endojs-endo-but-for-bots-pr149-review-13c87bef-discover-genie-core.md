...
Inspect the embodied root agent, primordial agent, model command, model persistence, provider selection, and self-boot changes.

Use an isolated checkout made with:
/home/kris/garden/scripts/jobs/ensure-project-worktree.sh endojs-endo-but-for-bots-pr149-review-13c87bef-discover-genie-core endojs/endo-but-for-bots jcorbin-exp-genie-bottle
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-13T21:16:14Z
