# Review directive on endojs/endo-but-for-bots PR #284

A trusted maintainer/contributor REVIEW on #284. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/284#pullrequestreview-4604615118
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/284/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/284/reviews/REVIEW_ID --jq .body
