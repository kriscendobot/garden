...
# botanist (auto: dependabot PR) on endojs/endo-but-for-bots PR #1051
...
Watcher preflight: parsed as a bump of `changesets/action` 1.9.0 -> 2.1.0, and NO other open
...
claim:
  ...
  provider: anthropic
  model: 
  claimed_at: 2026-08-23T19:55:41Z
