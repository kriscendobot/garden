...
dispatch: automatic
---
# attention directive on endojs/endo-but-for-bots PR #1105

Map: **attention** → read the directive and route it to the right work.

Source: pr-comment by kumavis
Comment: https://github.com/endojs/endo-but-for-bots/pull/1105#issuecomment-5494444831
...
Split per kumavis's request: this PR now carries only the two fixes (fence tolerance, BigInt serialization — head `220e2d82`, 7 tests). The compartment-rules documentation and the `sleep(ms)` endowment moved to #1111, stacked on this branch since its tool-description text docum

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1105 5494444831 kumavis
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-09-01T13:10:21Z
