...
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T17:13:03Z cleared=none -->
...
---
handler-timeout: 7200
# Complete realms, eval/global environments, ShadowRealm, and Annex B
...
`test/language/{eval-code,global-code}/**`, `test/built-ins/eval/**`, `test/built-ins/ShadowRealm/**`, and `test/annexB/**` except RegExp/String/Date slices already owned above.

Implementation scope:
Complete direct/indirect eval environments, declaration instantiation, restricted globals, cross-realm prototypes/errors, ShadowRealm evaluate/importValue/wrapping, HTML legacy built-ins and sloppy legacy semantics. Preserve a justified `IsHTMLDDA` host exclusion if the harness cannot supply that browser-only exotic; do not count it as engine coverage.
...
claim:
  ...
  provider: openai
  model: 
  claimed_at: 2026-08-14T17:13:07Z
