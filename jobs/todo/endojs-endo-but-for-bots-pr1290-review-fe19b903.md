...
# Review directive on endojs/endo-but-for-bots PR #1290

A trusted maintainer/contributor REVIEW on #1290. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/1290#pullrequestreview-5229123005
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/1290/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/1290/reviews/REVIEW_ID --jq .body
...
[INLINE-REVIEW] [CHANGES_REQUESTED] @kriscendobot We need a Playwright test in the top-level browser tests, consisting of a case bundled with the compartment mapper using the browser condition, to verify that browser bundles receive working sync or async sha256 on that platform. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1290 5229123005 kriskowal
