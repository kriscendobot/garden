...
# Fix Ironhorse fuzz finding 493390fc03979205 (target `differential_regexp_surface`) and amend the standing PR
...
- Minimized input sha256: `450a95b7db1bd744fc94f63a2842714b4e8bf996f97d589fb8aeef172dabbcf7` (4 bytes)
- Durable artifact (leader host): `/home/kris/garden/.garden-state/ironhorse-fuzz/findings/493390fc03979205/input.bin`
- Portable copy: `input_base64` in journal `ironhorse-fuzz/findings/493390fc03979205.md`
...
2. Recover the minimized input to a FILE without inlining it into any prompt:
   ...
   durable artifact path above. Verify `sha256sum` equals `450a95b7db1bd744fc94f63a2842714b4e8bf996f97d589fb8aeef172dabbcf7`.
...
7. Document THIS case and its solution in the standing PR body or a PR comment (finding 493390fc03979205).
8. If the case cannot yet be solved, still land the regression test as `#[ignore]` with a
   comment, and record the unsolved finding visibly in the PR — never let it disappear.

<!-- garden-transient-elapsed: kind=exit0 through=0 values=1566 -->
