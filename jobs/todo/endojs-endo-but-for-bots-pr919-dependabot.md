...
dispatch: automatic
---
# botanist (auto: dependabot PR) on endojs/endo-but-for-bots PR #919
...
Watcher preflight: parsed as a bump of `eslint-plugin-jsdoc` 62.9.0 -> 63.3.0, and NO other open
