# Issue from kriskowal on kriskowal/garden #65
...
Re-fetch the issue verbatim:  gh issue view 65 -R kriskowal/garden --comments
Reply when done:              gh issue comment https://github.com/kriskowal/garden/issues/65 --body "…"
