...
dispatch: automatic
---
# attention directive on kriscendobot/minion.town PR #34

Map: **attention** → read the directive and route it to the right work.

Source: pr-comment by kriskowal
Comment: https://github.com/kriscendobot/minion.town/pull/34#issuecomment-5247080255
...
The nameservers are updated. Please watch for DNS to propagate and inform the builder for this job that they can follow-up with zone management, fork the public suffix list and create a local PR, and notify the maintainer here and in their inbox when it is time to ferry the PR up

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/minion.town 34 5247080255 kriskowal
