...
# Fix Ironhorse fuzz finding 66facfd52ae8c673 (target `differential_source`) and amend the standing PR
...
- Minimized input sha256: `01fcc1b6133deca5503a6e86aae129cfc07ba53bd053b2d5ab227fed2b51baa7` (3 bytes)
- Durable artifact (leader host): `/home/kris/garden2/.garden-state/ironhorse-fuzz/findings/66facfd52ae8c673/input.bin`
- Portable copy: `input_base64` in journal `ironhorse-fuzz/findings/66facfd52ae8c673.md`
...
2. Recover the minimized input to a FILE without inlining it into any prompt:
   ...
   durable artifact path above. Verify `sha256sum` equals `01fcc1b6133deca5503a6e86aae129cfc07ba53bd053b2d5ab227fed2b51baa7`.
...
7. Document THIS case and its solution in the standing PR body or a PR comment (finding 66facfd52ae8c673).
8. If the case cannot yet be solved, still land the regression test as `#[ignore]` with a
   comment, and record the unsolved finding visibly in the PR — never let it disappear.

<!-- garden-transient-elapsed: kind=signature through=0 values=124 -->
