# Issue from dckc on kriskowal/garden #37
...
issue_spine: issue-kriskowal-garden-37
issue_url: https://github.com/kriskowal/garden/issues/37
submitter: dckc
----- END ISSUE NOTE -----

Re-fetch the issue verbatim:  gh issue view 37 -R kriskowal/garden --comments
Reply when done:              gh issue comment https://github.com/kriskowal/garden/issues/37 --body "…"

----- issue body excerpt (untrusted, truncated) -----
Open Collective is proving to be tedious to get going. Give me an endo x502 connector using base. 
