...
# botanist (auto: dependabot PR) on endojs/endo-but-for-bots PR #1053
...
Watcher preflight: parsed as a bump of `@rollup/plugin-commonjs` 28.0.6 -> 29.0.3, and NO other open
...
PR: https://github.com/endojs/endo-but-for-bots/pull/1053
