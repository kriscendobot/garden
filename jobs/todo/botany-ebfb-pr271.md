# Botany: assess and dispose of endo-but-for-bots dependabot PR #271

Repo: `endojs/endo-but-for-bots` (a bot-owned fork; the bot holds merge authority).
PR: #271 (authored by `dependabot[bot]`).
...
This repo is bot-owned and this job authorizes, for PR #271 specifically:
...
- **close** — on a REJECT verdict, `gh pr close 271` with the verdict comment attached.
...
Run the botanist workflow end to end on PR #271:
