...
Translate Mark Miller's article "the Grant Matcher problem" into documentation for docs.endojs.org.
...
## Source
Locate the AUTHORITATIVE version of Mark Miller's "the Grant Matcher problem" (Mark Miller's Grant Matcher / Grant Matcher Puzzle writeup, most likely on erights.org). Fetch it with
