# Review directive on endojs/endo-but-for-bots PR #586

A trusted maintainer/contributor REVIEW on #586. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/586#pullrequestreview-4613323605
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/586/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/586/reviews/REVIEW_ID --jq .body
