...
# Gauntlet stage: FIX round 6 — endojs/endo-but-for-bots PR #969
...
1. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh ironhorse-full-test262-automation-gauntlet-fix-6 endojs/endo-but-for-bots <pr-head-branch>`.
