# Botany: assess and dispose of endo-but-for-bots dependabot PR #275

Repo: `endojs/endo-but-for-bots` (a bot-owned fork; the bot holds merge authority).
PR: #275 (authored by `dependabot[bot]`).
...
This repo is bot-owned and this job authorizes, for PR #275 specifically:
...
- **close** — on a REJECT verdict, `gh pr close 275` with the verdict comment attached.
...
Run the botanist workflow end to end on PR #275:
