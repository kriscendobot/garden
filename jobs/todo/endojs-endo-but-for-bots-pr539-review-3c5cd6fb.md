# Review directive on endojs/endo-but-for-bots PR #539

A trusted maintainer/contributor REVIEW on #539. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/539#pullrequestreview-4576993485
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/539/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/539/reviews/REVIEW_ID --jq .body
...
[INLINE-REVIEW] [CHANGES_REQUESTED] These should be my last feedback. 
