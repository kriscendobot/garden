# Issue from kriskowal on kriskowal/garden #9
...
Re-fetch the issue verbatim:  gh issue view 9 -R kriskowal/garden --comments
Reply when done:              gh issue comment https://github.com/kriskowal/garden/issues/9 --body "…"
