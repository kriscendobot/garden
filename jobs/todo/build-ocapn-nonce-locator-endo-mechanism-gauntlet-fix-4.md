...
# Gauntlet stage: FIX round 4 — endojs/endo-but-for-bots PR #1124
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh build-ocapn-nonce-locator-endo-mechanism-gauntlet-fix-4 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
<!-- garden-transient-elapsed: kind=exit0 through=1 values=1083 -->
