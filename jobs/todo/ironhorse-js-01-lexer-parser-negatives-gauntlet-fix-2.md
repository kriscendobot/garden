...
# Gauntlet stage: FIX round 2 — endojs/endo-but-for-bots PR #970

You are ONE stage of a staged gauntlet (ironhorse-js-01-lexer-parser-negatives-gauntlet). Apply the panel's must-fix items ONCE,
push, watch CI, then STOP — do NOT re-run the panel (the driver re-posts panel-3).

1. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh ironhorse-js-01-lexer-parser-negatives-gauntlet-fix-2 endojs/endo-but-for-bots <pr-head-branch>`.
