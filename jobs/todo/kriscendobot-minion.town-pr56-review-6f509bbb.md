...
Review: https://github.com/kriscendobot/minion.town/pull/56#pullrequestreview-5084335131
...
[APPROVED] @kriscendobot Please conduct and dispatch a builder. Leave a note for the builder that whatever it learns in the process of building this, about using an OCapN CBOR client in the frontend, we should capture for future reference in the “primer” for Endo guests. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/minion.town 56 5084335131 kriskowal
