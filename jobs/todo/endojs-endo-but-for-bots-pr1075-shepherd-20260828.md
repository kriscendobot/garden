...
dispatch: automatic
---
# Shepherd endojs/endo-but-for-bots #1075 — regenerate Ironhorse hardened262 baselines, drive CI green

PR #1075 (AsyncFunction intrinsic-metadata hardened262 coverage) is OPEN, un-drafted,
and stalled RED on the gating `test-xs` check. Its conductor
(`endojs-endo-but-for-bots-pr1075-conduct`, in `jobs/tada/`) diagnosed the cause
...
> result baseline. This PR's new hardened262 `AsyncFunction` intrinsic-metadata test file
