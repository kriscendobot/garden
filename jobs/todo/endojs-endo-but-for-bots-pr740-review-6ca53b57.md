...
Review: https://github.com/endojs/endo-but-for-bots/pull/740#pullrequestreview-4779501767
...
[CHANGES_REQUESTED] A new requirement has nudged this design in a new direction. We want to be able to cross-compile the endor binary to other platforms and architectures, which we cannot so readily do with a C library dependency. Please provide options for cross-compilation with

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 740 4779501767 kriskowal
