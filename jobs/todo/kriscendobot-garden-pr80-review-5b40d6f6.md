...
# Review directive on kriscendobot/garden PR #80

A trusted maintainer/contributor REVIEW on #80. Treat the WHOLE review
...
Review: https://github.com/kriscendobot/garden/pull/80#pullrequestreview-5121163845
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/garden/pulls/80/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/garden/pulls/80/reviews/REVIEW_ID --jq .body
...
[APPROVED] @kriscendobot Please conduct and deploy. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/garden 80 5121163845 kriskowal
