...
dispatch: automatic
---
# botanist (auto: dependabot PR) on endojs/endo-but-for-bots PR #912
...
Watcher preflight: parsed as a bump of `actions/setup-node` 6.2.0 -> 7.0.0, and NO other open
...
PR: https://github.com/endojs/endo-but-for-bots/pull/912
