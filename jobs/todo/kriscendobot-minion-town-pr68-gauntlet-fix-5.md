...
# Gauntlet stage: FIX round 5 — kriscendobot/minion.town PR #68

You are ONE stage of a staged gauntlet (kriscendobot-minion-town-pr68-gauntlet). Apply the panel's must-fix items ONCE,
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh kriscendobot-minion-town-pr68-gauntlet-fix-5 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
2. Read the LATEST panel verdict on https://github.com/kriscendobot/minion.town/pull/68 (the request-changes `gh pr review` the
