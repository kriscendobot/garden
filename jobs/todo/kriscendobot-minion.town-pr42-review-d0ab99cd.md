...
# Review directive on kriscendobot/minion.town PR #42

A trusted maintainer/contributor REVIEW on #42. Treat the WHOLE review
...
Review: https://github.com/kriscendobot/minion.town/pull/42#pullrequestreview-4932690275
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/kriscendobot/minion.town/pulls/42/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/kriscendobot/minion.town/pulls/42/reviews/REVIEW_ID --jq .body
...
[INLINE-REVIEW] [CHANGES_REQUESTED] Please respond to this feedback locally but also follow up with issues on endo-but-for-bots where applicable because some of these designs require upstream work. This may also require us to build dependent designs to cover Minion Town specific 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh kriscendobot/minion.town 42 4932690275 kriskowal
