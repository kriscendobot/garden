...
You are ONE stage of a staged gauntlet (ironhorse-js-04-functions-constructors-base-classes-gauntlet). Do ONLY the clean stage, then STOP.
...
2. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh ironhorse-js-04-functions-constructors-base-classes-gauntlet-clean endojs/endo-but-for-bots <pr-head-branch>`
