...
# Fix Ironhorse fuzz finding 3ea435c58b4c588e (target `differential_regexp_surface`) and amend the standing PR
...
- Minimized input sha256: `9df4e2b4ff1278d84c09d3caad69d47b90401dae21573f6d581a7085716e1638` (4 bytes)
- Durable artifact (leader host): `/home/kris/garden2/.garden-state/ironhorse-fuzz/findings/3ea435c58b4c588e/input.bin`
- Portable copy: `input_base64` in journal `ironhorse-fuzz/findings/3ea435c58b4c588e.md`
...
2. Recover the minimized input to a FILE without inlining it into any prompt:
   ...
   durable artifact path above. Verify `sha256sum` equals `9df4e2b4ff1278d84c09d3caad69d47b90401dae21573f6d581a7085716e1638`.
...
7. Document THIS case and its solution in the standing PR body or a PR comment (finding 3ea435c58b4c588e).
8. If the case cannot yet be solved, still land the regression test as `#[ignore]` with a
   comment, and record the unsolved finding visibly in the PR — never let it disappear.

<!-- garden-transient-elapsed: kind=exit0 through=0 values=1136 -->
