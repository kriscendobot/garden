...
You are ONE stage of a staged gauntlet (ironhorse-js-26-ca-regexp-closure-audit-gauntlet). Do ONLY the clean stage, then STOP.
...
2. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh ironhorse-js-26-ca-regexp-closure-audit-gauntlet-clean endojs/endo-but-for-bots <pr-head-branch>`
