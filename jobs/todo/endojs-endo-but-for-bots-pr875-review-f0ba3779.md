...
dispatch: automatic
---
# Review directive on endojs/endo-but-for-bots PR #875

A trusted maintainer/contributor REVIEW on #875. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/875#pullrequestreview-4871669598
...
trailing number in the Review URL above), each with its file:line + text:
  gh api --paginate repos/endojs/endo-but-for-bots/pulls/875/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/875/reviews/REVIEW_ID --jq .body
...
[APPROVED] Please rebase, retcon, and weave. Then post a follow-up to refactor the npm-via-CAS registry proxy to provide more of its implementation in a JavaScript worker that employs the shared code in compartment-mapper, and also test the “endor” feature against the package

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 875 4871669598 kriskowal
