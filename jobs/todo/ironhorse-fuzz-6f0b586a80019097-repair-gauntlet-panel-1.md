...
You are ONE stage of a staged gauntlet (ironhorse-fuzz-6f0b586a80019097-repair-gauntlet). Run EXACTLY ONE panel round, post the
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh ironhorse-fuzz-6f0b586a80019097-repair-gauntlet-panel-1 <pr-head-owner>/<repo-name> <pr-head-branch>`.
...
<!-- garden-transient-elapsed: kind=signature through=1 values=496,2 -->
