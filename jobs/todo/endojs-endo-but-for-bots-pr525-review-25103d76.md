# Review directive on endojs/endo-but-for-bots PR #525

A trusted maintainer/contributor REVIEW on #525. Treat the WHOLE review
...
Review: https://github.com/endojs/endo-but-for-bots/pull/525#pullrequestreview-4575038927
...
trailing number in the Review URL above), each with its file:line + text:
  gh api repos/endojs/endo-but-for-bots/pulls/525/comments --jq '[.[]|select(.pull_request_review_id==REVIEW_ID)]'
and re-fetch the review body itself:
  gh api repos/endojs/endo-but-for-bots/pulls/525/reviews/REVIEW_ID --jq .body
