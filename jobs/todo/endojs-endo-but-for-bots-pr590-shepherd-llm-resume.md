# shepherd on endojs/endo-but-for-bots PR #590 (llm lint-ceiling resume)

Repo: endojs/endo-but-for-bots (bot-pushable; bot-repo only, no upstream endojs/endo touch).

PR #590 was blocked by the typescript-eslint project-service lint scaling ceiling and its
...
Task: rebase PR #590 onto current `origin/llm` and drive CI to green. Its base is live `llm`.
