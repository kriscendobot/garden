...
# botanist (auto: dependabot PR) on endojs/endo-but-for-bots PR #1173
...
Watcher preflight: parsed as a bump of `@vitejs/plugin-react` 4.7.0 -> 6.1.1, and NO other open
...
PR: https://github.com/endojs/endo-but-for-bots/pull/1173
