...
dispatch: automatic
---
# attention directive on endojs/endo-but-for-bots PR #1040

Map: **attention** → read the directive and route it to the right work.

Source: pr-comment by kriskowal
Comment: https://github.com/endojs/endo-but-for-bots/pull/1040#issuecomment-5362099915
...
After this merges, please also plan a job to add ironhorse and ironhorse+ses to the coverage matrix and then annotate the existing planned jobs pertaining to ironhorse development that hardened262 has become available to them for the purpose of ratcheting up parity and coverage. 

## BEFORE you edit — run the recheck preflight (deterministic)

A peer may have already resolved this feedback. Run, from the garden root:

  scripts/jobs/gardening/pr-feedback-preflight.sh endojs/endo-but-for-bots 1040 5362099915 kriskowal
