...
# Gauntlet stage: PANEL round 6 — endojs/endo-but-for-bots PR #992
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh endojs-endo-but-for-bots-pr992-gauntlet-panel-6 endojs/endo-but-for-bots <pr-head-branch>`.
