# Botany: assess and dispose of endo-but-for-bots dependabot PR #273

Repo: `endojs/endo-but-for-bots` (a bot-owned fork; the bot holds merge authority).
PR: #273 (authored by `dependabot[bot]`).
...
This repo is bot-owned and this job authorizes, for PR #273 specifically:
...
- **close** — on a REJECT verdict, `gh pr close 273` with the verdict comment attached.
...
Run the botanist workflow end to end on PR #273:
