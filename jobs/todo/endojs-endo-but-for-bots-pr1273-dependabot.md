...
# botanist (auto: dependabot PR, INCOMPATIBLE by preflight) on endojs/endo-but-for-bots PR #1273
...
Package: `@changesets/cli` 2.31.0 -> 3.0.2
Proof: `package.json` declares Node `^20.17.0 || >=22.9.0` (floor 20.17.0), but `@changesets/cli` 3.0.2 requires Node
...
PR: https://github.com/endojs/endo-but-for-bots/pull/1273
