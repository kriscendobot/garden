...
1. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh ironhorse-js-03-object-mop-descriptors-gauntlet-panel-1 endojs/endo-but-for-bots <pr-head-branch>`.
