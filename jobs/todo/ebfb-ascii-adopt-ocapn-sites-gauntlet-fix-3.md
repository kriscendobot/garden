...
# Gauntlet stage: FIX round 3 — endojs/endo-but-for-bots PR #980
...
1. Get an ISOLATED project checkout of the PR head:
   `/home/kris/garden2/scripts/jobs/ensure-project-worktree.sh ebfb-ascii-adopt-ocapn-sites-gauntlet-fix-3 endojs/endo-but-for-bots <pr-head-branch>`.
