...
tier: mentor
---
<!-- garden-promoted-from-plan: gate=orchestrated priority=normal at=2026-08-14T23:46:28Z cleared=none -->
...
dispatch: automatic
---
# Close residual language gap: Function apply/call/callback on non-user-function receivers, ToPrimitive, and non-primitive-completion

Part of the js-26 residual-closure orchestration (measured on PR endojs/endo-but-for-bots#970 head `b3c3ae93`). **This cluster: 707 actionable cases** (unsupported + ironhorse-failure) as measured by the authoritative full-suite run at that head.

**Causal reason families in scope:**
- `unsupported-opcode` — 407
- `non-primitive-completion` — 299
- `strict:unsupported-opcode:to_primitive:no-primitive-result` — 1

**Top test262 subtrees:**
- `language/expressions` — 150
- `language/statements` — 111
- `language/identifiers` — 92
- `built-ins/Temporal` — 47
- `built-ins/String` — 46
- `built-ins/Object` — 39
- `built-ins/Array` — 26
- `language/future-reserved-words` — 23
- `built-ins/Function` — 15
- `language/computed-property-names` — 14
