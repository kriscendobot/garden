...
# Gauntlet stage: FIX round 2 — endojs/endo-but-for-bots PR #988
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh endojs-endo-but-for-bots-pr988-gauntlet-fix-2 endojs/endo-but-for-bots <pr-head-branch>`.
