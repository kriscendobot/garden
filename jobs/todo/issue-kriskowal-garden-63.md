# Issue from kriskowal on kriskowal/garden #63
...
Re-fetch the issue verbatim:  gh issue view 63 -R kriskowal/garden --comments
Reply when done:              gh issue comment https://github.com/kriskowal/garden/issues/63 --body "…"
