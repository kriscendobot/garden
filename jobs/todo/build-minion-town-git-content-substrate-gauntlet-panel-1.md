...
# Gauntlet stage: PANEL round 1 — kriscendobot/minion.town PR #48
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh build-minion-town-git-content-substrate-gauntlet-panel-1 <pr-head-owner>/<repo-name> <pr-head-branch>`.
