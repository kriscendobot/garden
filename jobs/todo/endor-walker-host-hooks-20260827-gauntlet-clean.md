...
You are ONE stage of a staged gauntlet (endor-walker-host-hooks-20260827-gauntlet). Do ONLY the clean stage, then STOP.
...
2. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh endor-walker-host-hooks-20260827-gauntlet-clean <pr-head-owner>/<repo-name> <pr-head-branch>`.
