...
gauntlet: ironhorse-js-26-ca-regexp-properties-gauntlet
...
You are ONE stage of a staged gauntlet (ironhorse-js-26-ca-regexp-properties-gauntlet). Run EXACTLY ONE panel round, post the
...
1. Get an ISOLATED project checkout of the PR head:
   `scripts/jobs/ensure-project-worktree.sh ironhorse-js-26-ca-regexp-properties-gauntlet-panel-1 endojs/endo-but-for-bots <pr-head-branch>`.
