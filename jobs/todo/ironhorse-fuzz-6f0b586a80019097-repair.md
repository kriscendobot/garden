...
# Fix Ironhorse fuzz finding 6f0b586a80019097 (target `differential_regexp_surface`) and amend the standing PR
...
- Minimized input sha256: `7637ee2cbd7ed3fbb4ceb06ff0e8fc37f4e64308a503b6f8bb388e2fbf965497` (5 bytes)
- Durable artifact (leader host): `/home/kris/garden2/.garden-state/ironhorse-fuzz/findings/6f0b586a80019097/input.bin`
- Portable copy: `input_base64` in journal `ironhorse-fuzz/findings/6f0b586a80019097.md`
...
2. Recover the minimized input to a FILE without inlining it into any prompt:
   ...
   durable artifact path above. Verify `sha256sum` equals `7637ee2cbd7ed3fbb4ceb06ff0e8fc37f4e64308a503b6f8bb388e2fbf965497`.
...
7. Document THIS case and its solution in the standing PR body or a PR comment (finding 6f0b586a80019097).
8. If the case cannot yet be solved, still land the regression test as `#[ignore]` with a
   comment, and record the unsolved finding visibly in the PR — never let it disappear.

<!-- garden-transient-elapsed: kind=signature through=0 values=184 -->
