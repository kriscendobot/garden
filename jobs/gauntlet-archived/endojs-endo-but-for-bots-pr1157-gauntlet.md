...
stage_retries: 0
max_stage_retries: 2
current_child: endojs-endo-but-for-bots-pr1157-gauntlet-fix-3
state: running
created_by: producer
...
Staged gauntlet run over https://github.com/endojs/endo-but-for-bots/pull/1157 (feature).
Posted by the completion edge of build `design-npm-registry-indelible-guest-inventory`.
