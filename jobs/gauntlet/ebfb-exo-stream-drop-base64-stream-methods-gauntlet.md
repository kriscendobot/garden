...
resumes: 0
max_resumes: 6
current_child: ebfb-exo-stream-drop-base64-stream-methods-gauntlet-panel-2
state: running
created_by: producer
...
Posted by the completion edge of build `ebfb-exo-stream-drop-base64-stream-methods`.
